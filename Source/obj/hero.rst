...
Hexadecimal [16-Bits]
                             ...
                             16 ;;    along with this program.  If not, see <https://www.gnu.org/licenses/>.
                             17 ;;------------------------------------------------------------------------------------------------------
                             18 .globl  sys_physics_jump_control
                             19 .globl  sys_physics_end_of_jump
                             20 .globl  sys_physics_startJump
                             21 .globl  sys_physics_move_hero_right
                             22 .globl  sys_physics_move_hero_left
                             23 .globl  sys_physics_estoy_arriba
                             24 .globl  sys_physics_startFall
                             25 .globl  sys_physics_fall_control
                             26 .globl  sys_collision_check
...
Hexadecimal [16-Bits]
                             ...
                             29 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             30 ;;
                             31 ;;  LLAMA AL CONTROL DE SALTO, DE CAIDA Y RECIBE INFORMACION DE LAS TECLAS W,A,S,D DEL TECLADO
                             32 ;;
                             33 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   4356                      34 hero_update::
   4356 CD 90 61      [17]   35    call  sys_physics_fall_control
   4359 CD 1E 61      [17]   36    call  sys_physics_jump_control
   435C CD 8D 43      [17]   37    call  keyboard_inputs
   435F C9            [10]   38 ret
                             39 
                             40 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             41 ;;
                             42 ;;  INICIALIZA LA INFORMACION DE LA ENTIDAD HEROE
                             43 ;;
                             44 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   4360                      45 hero_init::
                             46     ;;_posicion 0x0B -> ABAJO   _posicion 0x0A -> ARRIB
                             47     ;;DefineHero        _x,     _y,     _w,     _h,     _vx,    _vy,    tipo,     _salto,         _posicion, _animacion
   4360                      48     DefineEntity heroe    0x00,   0xB4,   0x06,   0x09,   0x00,   0x00,   0x03,       0xFF,           0x0B,     0x00
   000A                       1 heroe::
   4360 00                    2     .db 0x00
   4361 B4                    3     .db 0xB4
   4362 06                    4     .db 0x06
   4363 09                    5     .db 0x09
   4364 00                    6     .db 0x00
   4365 00                    7     .db 0x00     ;;Marcador para saber si debemos destruir la entidad o no
   4366 03                    8     .db 0x03
   4367 FF                    9     .db 0xFF
   4368 0B                   10     .db 0x0B
   4369 00                   11     .db 0x00
   436A C9            [10]   49 ret
                             ...
                             52 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             53 ;;
                             54 ;;  DEVUELVE EN IX EL PRIMER BYTE DE LA DIRECCION DE LA ENTIDAD HEROE
                             55 ;;  DESTROYED REGISTER VALUES: IX
                             56 ;;  RETURNS; IX
                             57 ;;
                             58 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   436B                      59 hero_getIXPtr::
   436B DD 21 60 43   [14]   60     ld ix, #heroe
   436F C9            [10]   61 ret
                             62 
   4370                      63 hero_getIYPtr::
   4370 FD 21 60 43   [14]   64     ld iy, #heroe
   4374 C9            [10]   65 ret
...
Hexadecimal [16-Bits]
                             ...
                             67 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             68 ;;
                             69 ;;  REESTABLECE LOS VALORES POR DEFECTO DEL HERIE
                             70 ;;  DESTROYED REGISTER VALUES: A
                             71 ;;  REQUIERE; PUNTERO IX CON LA DIRECCION DE MEMORIA DEL HEROE
                             72 ;;
                             73 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   4375                      74 hero_restart::
   4375 CD 6B 43      [17]   75     call hero_getIXPtr
   4378 3E 00         [ 7]   76     ld a, #0
   437A DD 77 00      [19]   77     ld h_x(ix), a 
   437D 3E B4         [ 7]   78     ld a, #0xB4
   437F DD 77 01      [19]   79     ld h_y(ix), a
   4382 3E FF         [ 7]   80     ld a, #0xFF
   4384 DD 77 07      [19]   81     ld h_salto(ix), a
   4387 3E 0B         [ 7]   82     ld a, #0x0B
   4389 DD 77 08      [19]   83     ld h_posicion(ix), a
   438C C9            [10]   84 ret
                             85 
                             86 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             87 ;;
                             88 ;;  RECOGE INFORMACION DEL TECLADO, DE LAS TECLAS W, A, S, D.
                             89 ;;  LLAMA A LOS MOVIMIENTOS IZQUIERDA Y DERECHA
                             90 ;;  LLAMA A LAS FUNCIONES START JUMP Y START FALL
                             91 ;;  DESTROYED REGISTER VALUES: A, D, BC, HL, IX
                             92 ;;
                             93 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   438D                      94 keyboard_inputs::
   438D CD 6B 43      [17]   95     call hero_getIXPtr
                             96     ;;Escanea el teclado completo 
   4390 CD AF 73      [17]   97     call cpct_scanKeyboard_asm
                             98     
                             99     ;;Comprueba si la tecla 'D' esta presionada
   4393 21 03 08      [10]  100     ld hl,  #Key_P                      ;; HL = Key_P KeyCode
   4396 CD E0 68      [17]  101     call    cpct_isKeyPressed_asm       ;; Comprueba si la "P" esta pulsada
   4399 FE 00         [ 7]  102     cp      #0                          ;; Comprueba si P == 0
   439B 28 03         [12]  103     jr      z, d_not_pressed            ;; Salta si P == 0 (D no esta pulsada)
                            104         ;; D esta pulsada
   439D CD 78 61      [17]  105         call sys_physics_move_hero_right
   43A0                     106     d_not_pressed:
                            107 
                            108 
                            109     ;;Comprueba si la tecla 'A' esta presionada
   43A0 21 04 04      [10]  110     ld hl,  #Key_O                      ;;HL = Key_O KeyCode
   43A3 CD E0 68      [17]  111     call    cpct_isKeyPressed_asm       ;;Comprueba si la "O" esta pulsada
   43A6 FE 00         [ 7]  112     cp      #0                          ;;Comprueba si O == 0
   43A8 28 03         [12]  113     jr      z, a_not_pressed            ;;Salta si O == 0 (O no esta pulsada)
                            114         ;; A esta pulsada
   43AA CD 84 61      [17]  115          call sys_physics_move_hero_left
   43AD                     116     a_not_pressed:
                            117 
                            118 
                            119     ;;Comprueba si la tecla 'W' esta presionada, y si esta presionada empieza el salto
   43AD 21 08 08      [10]  120     ld hl,  #Key_Q                      ;; HL = Key_Q KeyCode
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 59.
Hexadecimal [16-Bits]



   43B0 CD E0 68      [17]  121     call    cpct_isKeyPressed_asm       ;; Comprueba si la "Q" esta pulsada
   43B3 FE 00         [ 7]  122     cp      #0                          ;;define
   43B5 28 03         [12]  123     jr      z, w_not_pressed    
   43B7 CD 5A 61      [17]  124         call sys_physics_startJump
                            125 
   43BA                     126     w_not_pressed:
                            127         
   43BA                     128         do_not_jump:
                            129     
                            130 
                            131     ;;Comprueba si la tecla 'S' esta presionada, y si esta presionada empieza la caida
   43BA 21 08 20      [10]  132     ld hl,  #Key_A                      ;; HL = Key_A KeyCode
   43BD CD E0 68      [17]  133     call    cpct_isKeyPressed_asm       ;; Comprueba si la "A" esta pulsada
   43C0 FE 00         [ 7]  134     cp      #0                          ;;define
   43C2 28 03         [12]  135     jr      z, s_not_pressed    
   43C4 CD BE 61      [17]  136         call sys_physics_startFall
                            137 
   43C7                     138     s_not_pressed:
                            139         
   43C7                     140         do_not_fall:
   43C7 C9            [10]  141     ret
