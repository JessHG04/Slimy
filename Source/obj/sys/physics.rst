...
Hexadecimal [16-Bits]
                             ...
                             20 .include "cpctelera_functions.h.s"
                              1 ;;----------------------------------LICENSE NOTICE-----------------------------------------------------
                              2 ;;Slimy is a challenging videogame made for Amstrad CPC
                              3 ;;    Copyright (C) 2020  Maria del Rosario Fernandez Garcia // David Llopis Romero // Jessica Hernandez Gomez
                              4 ;;
...
Hexadecimal [16-Bits]
   ...
   60FD FB                   25     .db     #-5         
   60FE FB                   26     .db     #-5          ;;20
   60FF FC FC                27     .db     #-4, #-4           ;;12
   6101 FC FC FC FD FD       28     .db     #-4, #-4, #-4, #-3, #-3      ;;15
   6106 FE FE FE FE FE       29     .db     #-2, #-2, #-2, #-2, #-2      ;;10       
   610B FE FE FE FE FE       30     .db     #-2, #-2, #-2, #-2, #-2
   6110 FF FF FF FF FF FF    31     .db     #-1, #-1, #-1, #-1 , #-1, #-1   ;;5           
                             32   
   6116 80                   33     .db     #0x80
                             34   
                             35 
   6117                      36 falltable:
                             37     ;;.db      #6, #8     
                             38     ;;.db      #22, #26     TOTAL: 62
   6117 06 08 0A             39     .db     #6,     #8,     #10
   611A 0C 0C 0E             40     .db     #12,    #12,    #14
                             41 
   611D 80                   42     .db     #0x80
                             43 
                             44 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             45 ;;
                             46 ;;  CONTROLA EL SALTO DEL HEROE, REQUIERE PUNTERO IX AL PRIMER BYTE DEL HEROE
                             47 ;;  DESTROYED REGISTER VALUES: IX, A, BC, HL
                             48 ;;
                             49 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             50 
                             51 
   611E                      52 sys_physics_jump_control::
   611E CD 6B 43      [17]   53     call hero_getIXPtr  
                             54 
                             55     ;;Controla si ahora mismo estamos saltando                
   6121 DD 7E 07      [19]   56     ld a, h_salto(ix)                   ;; Cargo el status del salto en a
   6124 FE FF         [ 7]   57     cp #-1                              ;; -1 indica que el heroe no esta saltando
   6126 C8            [11]   58     ret z                               ;; Si A == -1 no salta
                             59 
   6127 DD 7E 08      [19]   60     ld a, h_posicion(ix)                ;; Cargo la posicion del heroe en a (arriba o abajo)
   612A FE 0A         [ 7]   61     cp #0x0A                            ;; 0x0A indica que el heroe esta arriba ya
   612C C8            [11]   62     ret z                               ;; Si ya esta arriba, no podemos seguir saltando
                             63     
                             64 
                             65     ;;Get jump value
   612D DD 7E 07      [19]   66     ld a, h_salto(ix)                   ;; Cargo en a el status del salto
   6130 21 FD 60      [10]   67     ld      hl, #jumptable              ;; HL apunta al inicio de la tabla de salto
   6133 4F            [ 4]   68     ld      c,  a                       ;; Cargo en c el contenido de a y en b cargo un 0 para que el registro
   6134 06 00         [ 7]   69     ld      b,  #0                      ;; BC sea igual a A (Offset)
   6136 09            [11]   70     add     hl, bc                      ;; HL += BC incremento hl lo que me indica bc para ir desplazandome por la tabla de salto
                             71 
                             72 
                             73     ;; Check End of jumping
   6137 7E            [ 7]   74     ld      a, (hl)                     ;; Cargo en a el contenido de la direccion de memoria que indica hl
   6138 FE 80         [ 7]   75     cp      #0x80                       ;; Si es un 80 querra decir que ya hemos terminado de leer la tabla de salto y ya podemos parar
   613A 28 10         [12]   76     jr      z, sys_physics_end_of_jump  ;; Dejo de leer la tabla de salto y llamo al manejador de fin de salto
                             77 
...
Hexadecimal [16-Bits]
                             ...
                             78 
                             79     ;; Do Jump Movement
   613C 47            [ 4]   80     ld      b, a                        ;; A = Jump Movement // A tiene el contenido de la direccion de memoria de HL (sera un valor de la tabla de salto)
   613D DD 7E 01      [19]   81     ld      a, h_y(ix)                  ;; a = Posicion y del heroe
   6140 80            [ 4]   82     add     b                           ;; Le sumo a la posicion del heroe el valor de la tabla de salto (que esta almacenado en b)
   6141 DD 77 01      [19]   83     ld      h_y(ix), a                  ;; Cambio la posicion del heroe cargando el contenido del registro a
                             84     
                             85 
                             86 
                             87     ;; Increment Hero Jump Index
   6144 DD 7E 07      [19]   88     ld      a, h_salto(ix)              ;; A = Hero_jump
   6147 3C            [ 4]   89     inc     a                           ;; Incremento a para leer el siguiente valor de la tabla jump
   6148 DD 77 07      [19]   90     ld      h_salto(ix), a              ;; Cargo el contenido del status de salto en a
   614B C9            [10]   91 ret
                             92 
                             93 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             94 ;;
                             95 ;;  TERMINA EL SALTO PONIENDO LA ETIQUETA H_SALTO A -1
                             96 ;;  DESTROYED REGISTER VALUES: A
                             97 ;;
                             98 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   614C                      99 sys_physics_end_of_jump::
   614C 3E FF         [ 7]  100     ld    a,                #-1
   614E DD 77 07      [19]  101     ld    h_salto(ix),      a 
                            102 
                            103     ;;Controla si estamos en la parte de arriba
   6151 DD 7E 01      [19]  104     ld              a,      h_y(ix)
   6154 FE 76         [ 7]  105     cp #0x76                     ;;Si mi posicion es 0x51 en el eje y, establezco el _posicion a 0x0A (arriba)
   6156 CC 6F 61      [17]  106     call z, sys_physics_estoy_arriba
   6159 C9            [10]  107 ret
                            108 
                            109 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            110 ;;
                            111 ;;  COMIENZA EL SALTO (COMPRUEBA ANTES QUE NO ESTEMOS YA EN UN SALTO Y, SI NO LO ESTAMOS, PONE H_SALTO A 0)
                            112 ;;
                            113 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   615A                     114 sys_physics_startJump::
   615A CD 6B 43      [17]  115     call    hero_getIXPtr 
   615D DD 7E 07      [19]  116     ld      a, h_salto(ix)
   6160 FE FF         [ 7]  117     cp      #-1                         ;; Comprueba que el h_salto sea -1 para que, si no esta saltando, siga con la funcion y el salto se inicie
   6162 C0            [11]  118     ret     nz                          ;; Si es un 0 seguimos con la funcion (Si NO es un 0, no seguimos con la funcion)
                            119 
   6163 DD 7E 08      [19]  120     ld      a, h_posicion(ix)           ;;Si el personaje ya esta arriba no iniciamos el salto
   6166 FE 0A         [ 7]  121     cp      #0x0A
   6168 C8            [11]  122     ret     z
                            123     ;; (El resultado de cp #-1 sera 0 si el heroe NO esta saltando y distinto de 0 o nz si el heroe SI esta saltando)
                            124     ;; Jump is inactive, activate it
   6169 3E 00         [ 7]  125     ld      a       , #0
   616B DD 77 07      [19]  126     ld  h_salto(ix) , a
                            127 
   616E C9            [10]  128     ret
                            129 
                            130 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            131 ;;
                            132 ;;  SI EL HEROE ESTA ARRIBA (POSICION Y: 0x00), CAMBIAMOS LA ETIQUETA H_POSICION A 0x0A
...
Hexadecimal [16-Bits]
                            ...
                            133 ;;
                            134 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   616F                     135 sys_physics_estoy_arriba::
   616F CD 6B 43      [17]  136       call hero_getIXPtr
   6172 3E 0A         [ 7]  137       ld a, #0x0A
   6174 DD 77 08      [19]  138       ld h_posicion(ix), a
   6177 C9            [10]  139   ret
                            140 
                            141 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            142 ;;
                            143 ;;  MUEVE EL HEROE HACIA LA DERECHA
                            144 ;;  DESTROYED REGISTER VALUES: A, D, BC, HL
                            145 ;;
                            146 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   6178                     147 sys_physics_move_hero_right::
                            148 
   6178 DD 7E 00      [19]  149         ld      a, h_x(ix)
   617B FE 48         [ 7]  150         cp      #80-8               ;;Comprueba el limite derecho (Tamanyo de la pantalla - Tamanyo del heroe)
   617D 28 04         [12]  151         jr      z, do_not_move_r        ;;Posicion x heroe == limite de pantalla, asi que NO se mueve a la derecha
                            152 
                            153             ;; Move right
   617F 3C            [ 4]  154             inc     a 
   6180 DD 77 00      [19]  155             ld      h_x(ix), a          ;;Actualizo la posicion del heroe
                            156         
   6183                     157         do_not_move_r:
   6183 C9            [10]  158 ret
                            159 
                            160 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            161 ;;
                            162 ;;  MUEVE EL HEROE HACIA LA IZQUIERDA
                            163 ;;  DESTROYED REGISTER VALUES: A, D, BC, HL
                            164 ;;
                            165 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   6184                     166 sys_physics_move_hero_left::
                            167 
   6184 DD 7E 00      [19]  168         ld      a, h_x(ix)
   6187 FE 00         [ 7]  169         cp      #00                     ;;Comprueba el limite izquierdo (inicio de la pantalla)
   6189 28 04         [12]  170         jr      z, do_not_move_l        ;; Si el heroe esta en el limite, no se mueve mas hacia la izquierda
                            171         
                            172             ;;Move left
   618B 3D            [ 4]  173             dec     a 
   618C DD 77 00      [19]  174             ld      h_x(ix), a
                            175 
   618F                     176         do_not_move_l: 
                            177 
   618F C9            [10]  178 ret
                            179 
                            180 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            181 ;;
                            182 ;;  CONTROLA LA CAIDA DEL HEROE
                            183 ;;  DESTROYED REGISTER VALUES: IX, BC, HL
                            184 ;;
                            185 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   6190                     186 sys_physics_fall_control::
   6190 CD 6B 43      [17]  187     call hero_getIXPtr  
...
Hexadecimal [16-Bits]
                            ...
                            188 
                            189     ;;Controla si ahora mismo estamos saltando                
   6193 DD 7E 07      [19]  190     ld a, h_salto(ix)                   ;; Hero jump status
   6196 FE FF         [ 7]  191     cp #-1                              ;; -1 indica que el heroe no esta saltando
   6198 C8            [11]  192     ret z                               ;; Si A == -1 no salta
                            193 
   6199 DD 7E 08      [19]  194     ld a, h_posicion(ix)
   619C FE 0B         [ 7]  195     cp #0x0B                            ;; Si nuestra posicion es 0x0B significa que ya estamos abajo
   619E C8            [11]  196     ret z                               ;; y por tanto no podemos caer mas
                            197 
                            198     ;;Get jump value
   619F DD 7E 07      [19]  199     ld a, h_salto(ix)                   ;; Hero jump status
   61A2 21 17 61      [10]  200     ld      hl, #falltable              ;; HL apunta al inicio de la tabla de jum
   61A5 4F            [ 4]  201     ld      c,  a
   61A6 06 00         [ 7]  202     ld      b,  #0                      ;; BC = A (Offset)
   61A8 09            [11]  203     add     hl, bc                      ;; HL += BC
                            204 
                            205     ;; Check End of jumping
   61A9 7E            [ 7]  206     ld      a, (hl)
   61AA FE 80         [ 7]  207     cp      #0x80                       ;; Jump Value == 0
   61AC 28 25         [12]  208     jr      z, sys_physics_end_of_fall
                            209 
                            210     ;; Do Jump Movement
   61AE 47            [ 4]  211     ld      b, a                        ;; A = Jump Movement
   61AF DD 7E 01      [19]  212     ld      a, h_y(ix)                  ;; a = Posicion y del heroe
   61B2 80            [ 4]  213     add     b                           ;; A+= 
   61B3 DD 77 01      [19]  214     ld      h_y(ix), a
                            215     
                            216 ;; Increment Hero Fall Index
   61B6 DD 7E 07      [19]  217     ld      a, h_salto(ix)              ;; A = Hero_jump                         ;;Si ha llegado arriba del todo no sigue saltando
   61B9 3C            [ 4]  218     inc     a 
   61BA DD 77 07      [19]  219     ld      h_salto(ix), a
   61BD C9            [10]  220 ret
                            221 
   61BE                     222 sys_physics_startFall::
   61BE CD 6B 43      [17]  223     call    hero_getIXPtr 
   61C1 DD 7E 07      [19]  224     ld      a, h_salto(ix)
   61C4 FE FF         [ 7]  225     cp      #-1                         ;; Comprueba que el h_salto sea -1 para que, si no esta saltando, siga con la funcion y el salto se inicie
   61C6 C0            [11]  226     ret     nz                          ;; Si es un 0 seguimos con la funcion (Si NO es un 0, no seguimos con la funcion)
                            227 
   61C7 DD 7E 08      [19]  228     ld      a, h_posicion(ix)           ;;Si el personaje ya esta arriba no iniciamos el salto
   61CA FE 0B         [ 7]  229     cp      #0x0B
   61CC C8            [11]  230     ret     z
                            231     ;; (El resultado de cp #-1 sera 0 si el heroe NO esta saltando y distinto de 0 o nz si el heroe SI esta saltando)
                            232     ;; Jump is inactive, activate it
   61CD 3E 00         [ 7]  233     ld      a       , #0
   61CF DD 77 07      [19]  234     ld  h_salto(ix) , a
                            235 
   61D2 C9            [10]  236     ret
                            237 
                            238 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            239 ;;;;
                            240 ;;;;  TERMINA LA CAIDA PONIENDO LA ETIQUETA H_SALTO A -1
                            241 ;;;;  Put -1 in the jump index when jump ends
                            242 ;;;;  DESTROYED REGISTER VALUES: A, IX
...
Hexadecimal [16-Bits]
                            ...
                            243 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   61D3                     244 sys_physics_end_of_fall::
   61D3 3E FF         [ 7]  245     ld      a,          #-1
   61D5 DD 77 07      [19]  246     ld    h_salto(ix),  a 
                            247                                       
   61D8 DD 7E 01      [19]  248     ld a, h_y(ix)
   61DB FE B4         [ 7]  249     cp #0xB4                            ;; Comprueba si estoy en el carril de abajo (posicion 0xB4)
   61DD CC E1 61      [17]  250     call z, sys_physics_estoy_abajo
   61E0 C9            [10]  251 ret
                            252 
                            253 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            254 ;;;;
                            255 ;;;;  COLOCA LA POSICION DEL HEROE O DEL OBSTACULO A 0x0B
                            256 ;;;;  DESTROYED REGISTER VALUES: IX, A
                            257 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   61E1                     258 sys_physics_estoy_abajo::
   61E1 CD 6B 43      [17]  259       call hero_getIXPtr
   61E4 3E 0B         [ 7]  260       ld a, #0x0B
   61E6 DD 77 08      [19]  261       ld h_posicion(ix), a
   61E9 C9            [10]  262   ret
                            263 
                            264 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            265 ;;;;
                            266 ;;;;  COMPRUEBA SI SE HA PRODUCIDO UNA COLISION O NO
                            267 ;;;;  Put -1 in the jump index when jump ends
                            268 ;;;;  IX: Entity_1 (Obstacles)
                            269 ;;;;  IY: Entity_2 ((Hero))
                            270 ;;;;  INPUT -> IX
                            271 ;;;;  DESTROYED REGISTER VALUES: IX, IY, AF, BC, DE, BC
                            272 ;;;;  SI SE PRODUCE UNA COLISION, REINICIAMOS EL JUEGO E INICIAMOS EL GAMEOVER
                            273 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   61EA                     274 sys_collision_check::
   61EA CD 70 43      [17]  275 call hero_getIYPtr
                            276     ;; if ( A < B) no collision
                            277     ;; A = e_x(ix) + e_w(ix)
                            278     ;; B = e_x(iy) 
                            279     ;; if ( e_x(ix) + e_w(ix)  <  e_x(iy)) ;;No collision
                            280     ;; if ( e_x(ix) + e_w(ix)  -  e_x(iy)) < 0 ;;No collision
   61ED DD 7E 00      [19]  281     ld          a, h_x(ix)
   61F0 DD 86 02      [19]  282     add         h_w(ix)       
   61F3 FD 96 00      [19]  283     sub         h_x(iy)
   61F6 38 31         [12]  284     jr          c, __no_collision
                            285 
                            286     ;; if ( C < D) no collision
                            287     ;; C = e_x(iy) + e_w(iy)
                            288     ;; D = e_x(ix) 
                            289     ;; if ( e_x(iy) + e_w(iy)  <  e_x(ix)) ;;No collision
                            290     ;; if ( e_x(iy) + e_w(iy)  -  e_x(ix)) < 0 ;;No collision
   61F8 FD 7E 00      [19]  291     ld          a, h_x(iy)
   61FB FD 86 02      [19]  292     add         h_w(iy)       
   61FE DD 96 00      [19]  293     sub         h_x(ix)
   6201 38 26         [12]  294     jr          c, __no_collision
                            295 
                            296    ;;EL CODIGO ANTERIOR ERA EN EL EJE X, AHORA EN EL EJE Y
   6203 DD 7E 01      [19]  297     ld          a, h_y(ix)
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 64.
Hexadecimal [16-Bits]



   6206 DD 86 03      [19]  298     add         h_h(ix)       
   6209 FD 96 01      [19]  299     sub         h_y(iy)
   620C 38 1B         [12]  300     jr          c, __no_collision
                            301 
                            302     
   620E FD 7E 01      [19]  303     ld          a, h_y(iy)
   6211 FD 86 03      [19]  304     add         h_h(iy)       
   6214 DD 96 01      [19]  305     sub         h_y(ix)
   6217 38 10         [12]  306     jr          c, __no_collision
                            307 
                            308   ;;SI HAY COLISION LLEGA AQUI
                            309 
   6219 DD 36 05 10   [19]  310     ld      h_vy(ix), #0x10
   621D 3E 00         [ 7]  311     ld a, #0
   621F 32 45 60      [13]  312     ld (_juego_pausado), a ;;Pausa el timer si hay colision
   6222 CD 52 48      [17]  313     call man_game_restart;;Reinicia el heroe y limpia obstaculos
   6225 CD 25 47      [17]  314     call man_gameover_run;;Invoca la pantalla gameover
                            315 
   6228 C9            [10]  316     ret
                            317 
   6229                     318 __no_collision:
                            319     
   6229 C9            [10]  320 ret
