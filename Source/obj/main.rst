...
Hexadecimal [16-Bits]
                             ...
                             22 .include "cpctelera_functions.h.s"
                              1 ;;----------------------------------LICENSE NOTICE-----------------------------------------------------
                              2 ;;Slimy is a challenging videogame made for Amstrad CPC
                              3 ;;    Copyright (C) 2020  Maria del Rosario Fernandez Garcia // David Llopis Romero // Jessica Hernandez Gomez
                              4 ;;
...
Hexadecimal [16-Bits]
   ...
   43C8                      33 _main::
                             ...
                             35    ;;call cpct_disableFirmware_asm
   43C8 CD 45 47      [17]   36    call man_game_init   
   43CB                      37    init_game::
   43CB CD DD 5F      [17]   38    call man_menu_run             ;; Bucle infinito hasta que se pulse espacio 
   43CE CD 60 43      [17]   39    call hero_init                ;; Inicializa al heroe con los datos por defecto. Lo mismo con el obstaculo
   43D1 CD 60 45      [17]   40    call obstacle_init  
                             41 
   43D4                      42 _lvl_control::;;Inicia el nivel en el que nos encontramos
                             43 
   43D4 CD 54 47      [17]   44    call man_game_init_lvl
                             45 
   43D7                      46 loop:
                             47     
                             48    ;;Heroe
   43D7 CD 74 63      [17]   49    call sys_render_clear_hero
   43DA CD 56 43      [17]   50    call hero_update              ;;Incluye la función de salto, de keyboard input y de caída
   43DD CD 44 63      [17]   51    call sys_render_update_hero
                             52    ;;Comprobacion si existen obstaculos
   43E0 CD 93 45      [17]   53    call obs_getNumObstacles_A
   43E3 FE 00         [ 7]   54    cp #0
   43E5 28 1E         [12]   55    jr z, no_enem
                             56 
                             57    ;;Obstaculos
   43E7 21 43 65      [10]   58    ld hl, #sys_render_clear_obstacle
   43EA CD 3C 46      [17]   59    call obs_doForAll
   43ED 21 DC 44      [10]   60    ld hl, #position_update
   43F0 CD 3C 46      [17]   61    call obs_doForAll
   43F3 21 7E 63      [10]   62    ld hl, #sys_render_update_obstacle
   43F6 CD 3C 46      [17]   63    call obs_doForAll
                             64    ;;Colisiones
   43F9 CD 70 43      [17]   65    call hero_getIYPtr
   43FC 21 EA 61      [10]   66    ld hl, #sys_collision_check
   43FF CD 3C 46      [17]   67    call obs_doForAll
                             68 
   4402 CD 97 45      [17]   69    call obs_destroy
                             70    
                             71 
   4405                      72 no_enem:
                             73 
   4405 CD 6D 48      [17]   74    call man_game_check_level;;Controla el nivel en el que nos encontramos
                             75 
   4408 CD 3D 6A      [17]   76    call cpct_waitVSYNC_asm
   440B 76            [ 4]   77    halt
   440C 76            [ 4]   78    halt
   440D 18 C8         [12]   79    jr    loop
