...
Hexadecimal [16-Bits]
                             ...
                             16 ;;    along with this program.  If not, see <https://www.gnu.org/licenses/>.
                             17 ;;------------------------------------------------------------------------------------------------------
                             18 .globl man_nextlevel_init
                             19 .globl man_nextlevel_run
...
Hexadecimal [16-Bits]
                             ...
                             25 
                             26 
   6042 00                   27 _tiempo_de_control:: .db 0
   6043 00                   28 _unidad_segundos:: .db 0
   6044 00                   29 _decena_segundos:: .db 0
   6045 00                   30 _juego_pausado:: .db 0          ;; 1 no pausado // 0 pausado
   6046 00                   31 _level_seconds:: .db 0
   6047 00                   32 animation_seconds:: .db 0
                             33 
   6048 35 00                34 _str_timers:   .asciz  "5"
   604A 31 00                35 _str_timerd:   .asciz  "1"
                             36 
                             37 ;;CONTROLA LAS INTERRUPCIONES DURANTE 1 SEGUNDO
   604C                      38 timer_control::
   604C 3A 45 60      [13]   39     ld a, (_juego_pausado)
   604F C8            [11]   40     ret z
   6050 3A 42 60      [13]   41     ld      a, (_tiempo_de_control)
   6053 FE 96         [ 7]   42     cp      #150                      ;; cada 300 interrupciones pasa 1 sec
   6055 CC 5D 60      [17]   43     call      z, timer_menos1s
   6058 3C            [ 4]   44     inc     a                       ;; si no, incrementamos y volvemos
   6059 32 42 60      [13]   45     ld      (_tiempo_de_control), a
   605C C9            [10]   46     ret
                             47 
                             48 ;;RESTA UN SEGUNDO AL CONTADOR
   605D                      49 timer_menos1s::
                             50     ;;Ha pasado un segundo del nivel
   605D 3A 46 60      [13]   51     ld a, (_level_seconds)
   6060 3C            [ 4]   52     inc a
   6061 32 46 60      [13]   53     ld (_level_seconds), a
                             54     ;; reseteamos el contador
   6064 3E 00         [ 7]   55     ld      a, #0
   6066 32 42 60      [13]   56     ld      (_tiempo_de_control), a
                             57     ;; incrementamos los segundos
   6069 3A 43 60      [13]   58     ld      a, (_unidad_segundos)
   606C FE 00         [ 7]   59     cp #0
   606E CC 7E 60      [17]   60     call z, timer_menos1d ;;LLEGAN A 0 LOS SEGUNDOS 
   6071 3D            [ 4]   61     dec     a
                             62 
   6072 32 43 60      [13]   63     ld      (_unidad_segundos), a  ;; lo, guardamos y volvemos
   6075 32 47 60      [13]   64     ld      (animation_seconds), a
   6078 C6 30         [ 7]   65     add #48 ;; PARA EL ASCI 
   607A 32 48 60      [13]   66     ld (_str_timers), a
                             67 
   607D C9            [10]   68     ret
   607E                      69 timer_menos1d::
                             70 
   607E 3A 44 60      [13]   71 ld a, (_decena_segundos)
   6081 3D            [ 4]   72 dec a
   6082 FE FF         [ 7]   73 cp #-1
   6084 CC 92 60      [17]   74 call z,timer_clear ;;AL TERMINAR EL CONTADOR HACE ESTO
                             75 
   6087 32 44 60      [13]   76 ld (_decena_segundos), a
   608A C6 30         [ 7]   77 add #48 ;; PARA EL ASCI 
   608C 32 4A 60      [13]   78 ld (_str_timerd), a
...
Hexadecimal [16-Bits]
                             ...
                             79 
   608F 3E 0A         [ 7]   80 ld a,  #10
   6091 C9            [10]   81 ret
                             82 
   6092                      83 timer_clear::;;BORRA TIMER E INVOCA PANTALLA NEXT LEVEL
                             84 
                             85     ;;Pauso el contador
   6092 3E 00         [ 7]   86     ld a, #0
   6094 32 45 60      [13]   87     ld (_juego_pausado), a
                             88     ;;Incremento el nivel
   6097 3A 43 47      [13]   89     ld a, (level)
   609A 3C            [ 4]   90     inc a
   609B 32 43 47      [13]   91     ld (level), a
                             92     ;;Invoco pantalla siguiente nivel
   609E CD 24 60      [17]   93     call man_nextlevel_run
                             94 
   60A1 C9            [10]   95 ret
                             96 
                             97 ;;SETEA EL VALOR DEL CRONOMETRO 
   60A2                      98 timer_value::
                             99     ;;Reinicio los segundos del nivel
   60A2 3E 00         [ 7]  100     ld a, #0 
   60A4 32 46 60      [13]  101     ld (_level_seconds), a
                            102     ;;Reseteo el contador
   60A7 3E 00         [ 7]  103     ld a, #0  
   60A9 32 43 60      [13]  104     ld (_unidad_segundos), a
   60AC 32 47 60      [13]  105     ld (animation_seconds), a
   60AF C6 30         [ 7]  106     add #48 ;; PARA EL ASCI 
   60B1 32 48 60      [13]  107     ld (_str_timers), a
   60B4 3E 03         [ 7]  108     ld a, #3
   60B6 32 44 60      [13]  109     ld (_decena_segundos), a
   60B9 C6 30         [ 7]  110     add #48 ;; PARA EL ASCI 
   60BB 32 4A 60      [13]  111     ld (_str_timerd), a
   60BE C9            [10]  112     ret
                            113 ;;DIBUJA EL CRONOMETRO
   60BF                     114 timer_render::
                            115 
   60BF C9            [10]  116 ret
