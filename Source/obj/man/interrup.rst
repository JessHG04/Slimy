...
Hexadecimal [16-Bits]
                             ...
                             22 
   4A5A 06                   23 uncontador: .db 06
                             24 
                             25 ;;Controla interrupciones
   4A5B                      26 int_handler::
   4A5B F5            [11]   27 push af
   4A5C C5            [11]   28 push bc
   4A5D D5            [11]   29 push de
   4A5E E5            [11]   30 push hl
                             31 
   4A5F CD 4C 60      [17]   32 call timer_control
   4A62 3A 5A 4A      [13]   33 ld a, (uncontador)
   4A65 3D            [ 4]   34 dec a
   4A66 20 05         [12]   35 jr nz, _cont
   4A68                      36 _zero:
   4A68 CD 94 6A      [17]   37 call cpct_akp_musicPlay_asm
   4A6B 3E 06         [ 7]   38 ld a, #6 
   4A6D                      39 _cont:
   4A6D 32 5A 4A      [13]   40 ld (uncontador), a
   4A70 E1            [10]   41 pop hl
   4A71 D1            [10]   42 pop de
   4A72 C1            [10]   43 pop bc
   4A73 F1            [10]   44 pop af
                             45 
   4A74 FB            [ 4]   46 ei
   4A75 ED 4D         [14]   47 reti
                             48 ;;INICIA INTERRUPCIONES
   4A77                      49 set_int_handler:
   4A77 21 38 00      [10]   50 ld hl, #0x38
   4A7A 36 C3         [10]   51 ld (hl), #0xC3
   4A7C 23            [ 6]   52 inc hl
   4A7D 36 5B         [10]   53 ld (hl), #<int_handler
   4A7F 23            [ 6]   54 inc hl
   4A80 36 4A         [10]   55 ld (hl), #>int_handler
   4A82 23            [ 6]   56 inc hl
   4A83 36 C9         [10]   57 ld (hl), #0xC9
   4A85 C9            [10]   58 ret
                             59 
