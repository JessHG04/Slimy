...
Hexadecimal [16-Bits]
                             ...
                             31 ;;=======================================================================
                             32 
   46F8 50 72 65 73 73 20    33 str_press2:  .asciz  "Press space to retry"
        73 70 61 63 65 20
        74 6F 20 72 65 74
        72 79 00
                             34 
                             ...
                             42 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   470D                      43 man_gameover_init::
                             44 
                             45     ;;Press String
   470D 21 04 00      [10]   46     ld      hl, #0x0004
   4710 CD 70 73      [17]   47     call    cpct_setDrawCharM0_asm
   4713 11 00 C0      [10]   48     ld      de, #0xC000
   4716 0E 00         [ 7]   49     ld       c, #0x00
   4718 06 95         [ 7]   50     ld       b, #0x95
   471A CD 93 73      [17]   51     call    cpct_getScreenPtr_asm
   471D FD 21 F8 46   [14]   52     ld      iy, #str_press2
   4721 CD 09 69      [17]   53     call    cpct_drawStringM0_asm
                             54 
                             55     
   4724 C9            [10]   56 ret
                             57 
                             ...
                             61 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             62 
   4725                      63 man_gameover_run::
   4725 CD 0D 47      [17]   64     call man_gameover_init
   4728 CD A2 60      [17]   65     call timer_value   ;;Coloca el contador a un valor por defecto para que no salta la comprobacion con 0
                             66     
   472B                      67     _control:
                             68     ;;Key control
   472B CD AF 73      [17]   69     call    cpct_scanKeyboard_asm
   472E 21 05 80      [10]   70     ld      hl, #Key_Space
   4731 CD E0 68      [17]   71     call    cpct_isKeyPressed_asm
   4734 28 F5         [12]   72     jr      z, _control
   4736 21 01 00      [10]   73     ld hl, #1
   4739 CD C4 65      [17]   74     call sys_render_clear_screen
   473C CD B7 46      [17]   75     call obs_destroy_all
   473F C3 D4 43      [10]   76     jp _lvl_control  ;; Volver al menu principal tras pulsar espacio;;REINICIAR NIVEL
