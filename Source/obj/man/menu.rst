...
Hexadecimal [16-Bits]
                             ...
                             25 .globl level
                             26 .globl _juego_pausado
                             27 
                             28 ;;=======================================================================
                             29 ;;PRIVATE FUNCTIONS
                             30 ;;=======================================================================
                             31 
   5FB1 53 6C 69 6D 79 00    32 str_menu:   .asciz  "Slimy"
   5FB7 50 72 65 73 73 20    33 str_press:  .asciz  "Press space to start"
        73 70 61 63 65 20
        74 6F 20 73 74 61
        72 74 00
                             34 
                             ...
                             38 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             39 ;;INIT
                             40 ;;      Initializes the main menu
                             41 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   5FCC                      42 man_menu_init::
                             43     ;;MODE 0
   5FCC CD 2F 63      [17]   44     call sys_render_init
                             45 
   5FCF 3E 01         [ 7]   46     ld a, #1
   5FD1 32 43 47      [13]   47     ld (level), a;;Desde el menu siempre vamos al nivel 1
   5FD4 3E 00         [ 7]   48     ld a, #0
   5FD6 32 45 60      [13]   49     ld (_juego_pausado), a
   5FD9 CD FB 65      [17]   50     call    sys_render_update_menu
   5FDC C9            [10]   51     ret
                             52 
                             53 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             54 ;;RUN
                             55 ;;      Runs the menu until finished
                             56 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             57 
   5FDD                      58 man_menu_run::
   5FDD CD A2 60      [17]   59     call timer_value              ;; PONE EL CRONOMETRO AL VALOR POR DEFECTO AL SALIR DEL MENU Y COMENZAR EL JUEGO;;usar esto al cargar cada nivel
                             60     
   5FE0 CD CC 5F      [17]   61     call man_menu_init            ;; Inicializa el menu
                             62   
   5FE3                      63     _run:
                             64     ;;Key control
   5FE3 CD AF 73      [17]   65     call    cpct_scanKeyboard_asm
   5FE6 21 05 80      [10]   66     ld      hl, #Key_Space
   5FE9 CD E0 68      [17]   67     call    cpct_isKeyPressed_asm
                             68     
   5FEC 28 F5         [12]   69     jr      z, _run
   5FEE 21 01 00      [10]   70     ld hl, #1
                             71 
   5FF1 C9            [10]   72     ret
                             73 
                             74 
