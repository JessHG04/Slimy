...
Hexadecimal [16-Bits]
                             ...
                             33 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   437E                      34 hero_update::
   437E CD B8 61      [17]   35    call  sys_physics_fall_control
   4381 CD 46 61      [17]   36    call  sys_physics_jump_control
   4384 CD B5 43      [17]   37    call  keyboard_inputs
   4387 C9            [10]   38 ret
                             39 
                             40 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             41 ;;
   ...
   4388                      48     DefineEntity heroe    0x00,   0xB4,   0x06,   0x09,   0x00,   0x00,   0x03,       0xFF,           0x0B,     0x00
   000A                       1 heroe::
   4388 00                    2     .db 0x00
   4389 B4                    3     .db 0xB4
   438A 06                    4     .db 0x06
   438B 09                    5     .db 0x09
   438C 00                    6     .db 0x00
   438D 00                    7     .db 0x00     ;;Marcador para saber si debemos destruir la entidad o no
   438E 03                    8     .db 0x03
   438F FF                    9     .db 0xFF
   4390 0B                   10     .db 0x0B
   4391 00                   11     .db 0x00
   4392 C9            [10]   49 ret
                             ...
                             57 ;;
                             58 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   4393                      59 hero_getIXPtr::
   4393 DD 21 88 43   [14]   60     ld ix, #heroe
   4397 C9            [10]   61 ret
                             62 
   4398                      63 hero_getIYPtr::
   4398 FD 21 88 43   [14]   64     ld iy, #heroe
   439C C9            [10]   65 ret
...
Hexadecimal [16-Bits]
                             ...
                             72 ;;
                             73 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   439D                      74 hero_restart::
   439D CD 93 43      [17]   75     call hero_getIXPtr
   43A0 3E 00         [ 7]   76     ld a, #0
   43A2 DD 77 00      [19]   77     ld h_x(ix), a 
   43A5 3E B4         [ 7]   78     ld a, #0xB4
   43A7 DD 77 01      [19]   79     ld h_y(ix), a
   43AA 3E FF         [ 7]   80     ld a, #0xFF
   43AC DD 77 07      [19]   81     ld h_salto(ix), a
   43AF 3E 0B         [ 7]   82     ld a, #0x0B
   43B1 DD 77 08      [19]   83     ld h_posicion(ix), a
   43B4 C9            [10]   84 ret
                             85 
                             86 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             87 ;;
                             ...
                             92 ;;
                             93 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   43B5                      94 keyboard_inputs::
   43B5 CD 93 43      [17]   95     call hero_getIXPtr
                             96     ;;Escanea el teclado completo 
   43B8 CD D7 73      [17]   97     call cpct_scanKeyboard_asm
                             98     
                             99     ;;Comprueba si la tecla 'D' esta presionada
   43BB 21 03 08      [10]  100     ld hl,  #Key_P                      ;; HL = Key_P KeyCode
   43BE CD 08 69      [17]  101     call    cpct_isKeyPressed_asm       ;; Comprueba si la "P" esta pulsada
   43C1 FE 00         [ 7]  102     cp      #0                          ;; Comprueba si P == 0
   43C3 28 03         [12]  103     jr      z, d_not_pressed            ;; Salta si P == 0 (D no esta pulsada)
                            104         ;; D esta pulsada
   43C5 CD A0 61      [17]  105         call sys_physics_move_hero_right
   43C8                     106     d_not_pressed:
                            107 
                            108 
                            109     ;;Comprueba si la tecla 'A' esta presionada
   43C8 21 04 04      [10]  110     ld hl,  #Key_O                      ;;HL = Key_O KeyCode
   43CB CD 08 69      [17]  111     call    cpct_isKeyPressed_asm       ;;Comprueba si la "O" esta pulsada
   43CE FE 00         [ 7]  112     cp      #0                          ;;Comprueba si O == 0
   43D0 28 03         [12]  113     jr      z, a_not_pressed            ;;Salta si O == 0 (O no esta pulsada)
                            114         ;; A esta pulsada
   43D2 CD AC 61      [17]  115          call sys_physics_move_hero_left
   43D5                     116     a_not_pressed:
                            117 
                            118 
                            119     ;;Comprueba si la tecla 'W' esta presionada, y si esta presionada empieza el salto
   43D5 21 08 08      [10]  120     ld hl,  #Key_Q                      ;; HL = Key_Q KeyCode
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 59.
Hexadecimal [16-Bits]



   43D8 CD 08 69      [17]  121     call    cpct_isKeyPressed_asm       ;; Comprueba si la "Q" esta pulsada
   43DB FE 00         [ 7]  122     cp      #0                          ;;define
   43DD 28 03         [12]  123     jr      z, w_not_pressed    
   43DF CD 82 61      [17]  124         call sys_physics_startJump
                            125 
   43E2                     126     w_not_pressed:
                            127         
   43E2                     128         do_not_jump:
                            129     
                            130 
                            131     ;;Comprueba si la tecla 'S' esta presionada, y si esta presionada empieza la caida
   43E2 21 08 20      [10]  132     ld hl,  #Key_A                      ;; HL = Key_A KeyCode
   43E5 CD 08 69      [17]  133     call    cpct_isKeyPressed_asm       ;; Comprueba si la "A" esta pulsada
   43E8 FE 00         [ 7]  134     cp      #0                          ;;define
   43EA 28 03         [12]  135     jr      z, s_not_pressed    
   43EC CD E6 61      [17]  136         call sys_physics_startFall
                            137 
   43EF                     138     s_not_pressed:
                            139         
   43EF                     140         do_not_fall:
   43EF C9            [10]  141     ret
