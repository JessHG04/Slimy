...
Hexadecimal [16-Bits]
                             ...
                             28 
                             29 
   4437                      30 obstacle_array::
   4437                      31     .ds max_obstacles*obstacle_size
   44FF C9            [10]   32 ret
                             33 
   4500 37 44                34 last_obs_ptr:: .dw #obstacle_array
   4502 00                   35 num_obstacles:: .db 0
   4503 00                   36 num_obstacles_marcados:: .db 0      ;; Esto lo quiero usar para obs_destroy
                             37 
                             38 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             39 ;;
                             40 ;;
                             ...
                             53 
                             54 
   4504                      55 position_update::
   4504 DD 7E 06      [19]   56     ld a, h_color(ix) ;;En realidad es el tipo
   4507 FE 03         [ 7]   57     cp #0x03
   4509 28 1B         [12]   58     jr z, obstacle_ghost_update
   450B 20 01         [12]   59     jr nz, obstacle_update
                             60 
   450D C9            [10]   61 ret
                             62 
   450E                      63 obstacle_update::
   450E DD 7E 00      [19]   64    ld   a, h_x(ix)
                             65    ;;cp   #00
                             66    ;;ret  z
   4511 3D            [ 4]   67    dec a
   4512 20 0D         [12]   68    jr nz,   move_left
   4514 DD 36 05 10   [19]   69             ld h_vy(ix), #0x10
   4518 3A 03 45      [13]   70             ld a, (num_obstacles_marcados) ;;Incremento en 1 el nº de obstaculos marcados
   451B C6 01         [ 7]   71             add #1
   451D 32 03 45      [13]   72             ld (num_obstacles_marcados), a
   4520 C9            [10]   73             ret 
   4521                      74     move_left:
   4521 DD 77 00      [19]   75     ld  h_x(ix), a
   4524 C9            [10]   76     ret
   4525 C9            [10]   77 ret
                             78 
                             79 ;;HACE QUE EL FANTASMA VAYA REBOTANDO
   4526                      80 obstacle_ghost_update::
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 63.
Hexadecimal [16-Bits]



   4526 DD 7E 00      [19]   81    ld   a, h_x(ix)
   4529 3D            [ 4]   82    dec a
   452A 20 0D         [12]   83    jr nz, move_left_ghost
                             84    
   452C DD 36 05 10   [19]   85             ld h_vy(ix), #0x10
   4530 3A 03 45      [13]   86             ld a, (num_obstacles_marcados) ;;Incremento en 1 el nº de obstaculos marcados
   4533 C6 01         [ 7]   87             add #1
   4535 32 03 45      [13]   88             ld (num_obstacles_marcados), a
   4538 C9            [10]   89             ret 
                             90 
   4539                      91     move_left_ghost:
   4539 DD 77 00      [19]   92     ld  h_x(ix), a
   453C DD 7E 01      [19]   93     ld  a, h_y(ix)
   453F FE 77         [ 7]   94     cp   #0x77
   4541 28 17         [12]   95     jr   z, _marcar_descender
   4543 FE 76         [ 7]   96     cp   #0x76
   4545 28 13         [12]   97     jr   z, _marcar_descender
   4547 FE B4         [ 7]   98     cp   #0xB4
   4549 28 1C         [12]   99     jr   z, _marcar_ascender
   454B FE B3         [ 7]  100     cp   #0xB3
   454D 28 18         [12]  101     jr   z, _marcar_ascender
   454F DD 7E 08      [19]  102     ld  a, h_posicion(ix)
   4552 FE 0D         [ 7]  103     cp  #0x0D
   4554 28 1E         [12]  104     jr   z, _descendiendo
   4556 FE 05         [ 7]  105     cp  #0x05
   4558 28 23         [12]  106     jr   z, _ascendiendo
                            107 
   455A                     108         _marcar_descender:
   455A 3E 0D         [ 7]  109             ld a, #0x0D
   455C DD 77 08      [19]  110             ld h_posicion(ix), a
   455F DD 7E 01      [19]  111             ld a, h_y(ix)
   4562 3C            [ 4]  112             inc a
   4563 DD 77 01      [19]  113             ld h_y(ix), a
   4566 C9            [10]  114         ret
   4567                     115         _marcar_ascender:
   4567 3E 05         [ 7]  116             ld a, #0x05
   4569 DD 77 08      [19]  117             ld h_posicion(ix), a
   456C DD 7E 01      [19]  118             ld a, h_y(ix)
   456F 3D            [ 4]  119             dec a
   4570 DD 77 01      [19]  120             ld h_y(ix), a
   4573 C9            [10]  121         ret
                            122 
   4574                     123         _descendiendo:
   4574 DD 7E 01      [19]  124             ld a, h_y(ix)
   4577 3C            [ 4]  125             inc a
   4578 3C            [ 4]  126             inc a
   4579 DD 77 01      [19]  127             ld h_y(ix), a
   457C C9            [10]  128         ret
                            129 
   457D                     130         _ascendiendo:
   457D DD 7E 01      [19]  131             ld a, h_y(ix)
   4580 3D            [ 4]  132             dec a 
   4581 3D            [ 4]  133             dec a
   4582 DD 77 01      [19]  134             ld h_y(ix), a
   4585 C9            [10]  135         ret
...
Hexadecimal [16-Bits]
   ...
   4588                     143     DefineEntity obstacle           0x46,   0xB4,   0x04,   0x04,   0x00,   0x00,   0x01,       0xFF,           0x0B,           0x00
   0151                       1 obstacle::
   4588 46                    2     .db 0x46
   4589 B4                    3     .db 0xB4
   458A 04                    4     .db 0x04
   458B 04                    5     .db 0x04
   458C 00                    6     .db 0x00
   458D 00                    7     .db 0x00     ;;Marcador para saber si debemos destruir la entidad o no
   458E 01                    8     .db 0x01
   458F FF                    9     .db 0xFF
   4590 0B                   10     .db 0x0B
   4591 00                   11     .db 0x00
   4592                     144     DefineEntity big_obstacle       0x46,   0xB4,   0x06,   0x25,   0x00,   0x00,   0x02,       0xFF,           0x0B,           0x00
   015B                       1 big_obstacle::
   4592 46                    2     .db 0x46
   4593 B4                    3     .db 0xB4
   4594 06                    4     .db 0x06
   4595 25                    5     .db 0x25
   4596 00                    6     .db 0x00
   4597 00                    7     .db 0x00     ;;Marcador para saber si debemos destruir la entidad o no
   4598 02                    8     .db 0x02
   4599 FF                    9     .db 0xFF
   459A 0B                   10     .db 0x0B
   459B 00                   11     .db 0x00
   459C                     145     DefineEntity moving_obstacle    0x46,   0xB4,   0x06,   0x09,   0x00,   0x00,   0x03,       0xFF,           0x0B,           0x00
   ...
   459F 09                    5     .db 0x09
   45A0 00                    6     .db 0x00
   45A1 00                    7     .db 0x00     ;;Marcador para saber si debemos destruir la entidad o no
   45A2 03                    8     .db 0x03
   45A3 FF                    9     .db 0xFF
   45A4 0B                   10     .db 0x0B
   45A5 00                   11     .db 0x00
   45A6                     146     DefineEntity wave_obstacle      0x40,   0xB4,   0x10,   0x14,   0x00,   0x00,   0x04,       0xFF,           0x0B,           0x00
   ...
   45A9 14                    5     .db 0x14
   45AA 00                    6     .db 0x00
   45AB 00                    7     .db 0x00     ;;Marcador para saber si debemos destruir la entidad o no
   45AC 04                    8     .db 0x04
   45AD FF                    9     .db 0xFF
   45AE 0B                   10     .db 0x0B
   45AF 00                   11     .db 0x00
...
Hexadecimal [16-Bits]
   ...
   45B0 C9            [10]  147 ret
                            ...
                            161 ;;  RETURNS: IX
                            162 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   45B1                     163 obs_getObstacleArray_IX::
   45B1 DD 21 37 44   [14]  164     ld      ix, #obstacle_array
   45B5 C9            [10]  165     ret
                            166 
                            167 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            168 ;;
                            ...
                            171 ;;  RETURNS: IY
                            172 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   45B6                     173 obs_getObstacleArray_IY::
   45B6 FD 21 37 44   [14]  174     ld      iy, #obstacle_array
   45BA C9            [10]  175     ret
                            176 
                            177 
                            178 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            ...
                            183 ;; 
                            184 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   45BB                     185 obs_getNumObstacles_A::
   45BB 3A 02 45      [13]  186     ld      a, (num_obstacles)
   45BE C9            [10]  187     ret
                            188 
                            189 
                            190 
                            ...
                            199 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            200 
   45BF                     201 obs_destroy::
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 66.
Hexadecimal [16-Bits]



   45BF CD B1 45      [17]  202     call obs_getObstacleArray_IX
   45C2 CD B6 45      [17]  203     call obs_getObstacleArray_IY
   45C5 CD BB 45      [17]  204     call obs_getNumObstacles_A
                            205     
   45C8                     206 _destroyloop:
   45C8 F5            [11]  207     push af
   45C9 DD 7E 05      [19]  208     ld      a, h_vy(ix) ;;Comprobamos con el parametro que queramos
   45CC FE 10         [ 7]  209     cp      #0x10       ;;Marcador
   45CE 28 02         [12]  210     jr      z, _destroy
   45D0 20 50         [12]  211     jr      nz, _seguir
                            212 
   45D2                     213 _destroy:
   45D2 21 6B 65      [10]  214     ld hl, #sys_render_clear_obstacle
   45D5 CD 64 46      [17]  215     call obs_doForAll
                            216     ;;ld hl, #obstacle_array + (obstacle_size*num_obstacles_marcados)  ;; Valor que quiero copiar
   45D8 3A 03 45      [13]  217     ld a, (num_obstacles_marcados)
   45DB FE 00         [ 7]  218     cp  #0
   45DD 28 43         [12]  219     jr z, _seguir
   45DF 11 0A 00      [10]  220     ld de, #obstacle_size
   45E2 21 37 44      [10]  221     ld hl, #obstacle_array
                            222 
   45E5                     223     _sumar:
   45E5 19            [11]  224     add hl, de
   45E6 3D            [ 4]  225     dec a
   45E7 20 FC         [12]  226     jr nz, _sumar
                            227 
   45E9 3A 03 45      [13]  228     ld a, (num_obstacles_marcados)
   45EC FE 02         [ 7]  229     cp #2
   45EE 28 02         [12]  230     jr z, _dos_obstaculos
   45F0 20 0B         [12]  231     jr nz, _un_obstaculo
                            232 
   45F2                     233     _dos_obstaculos:
   45F2 11 37 44      [10]  234     ld de, #obstacle_array                  ;; Lugar en el que lo voy a copiar
   45F5 01 14 00      [10]  235     ld bc, #max_obstacles                ;; Lo ideal sería poner el num_obstaculos * size, pero como soy una vaga y hay que hacer un bucle lo dejo en 70
   45F8 ED B0         [21]  236     ldir    
   45FA C3 05 46      [10]  237     jp _decrementar
   45FD                     238     _un_obstaculo:
   45FD 11 37 44      [10]  239     ld de, #obstacle_array                  ;; Lugar en el que lo voy a copiar
   4600 01 14 00      [10]  240     ld bc, #max_obstacles                  ;; Veces que voy a copiar
   4603 ED B0         [21]  241     ldir 
                            242 
                            243     
   ...
   4605                     248 _decrementar:
                            249      
                            250 
                            251       ;;CAMBIAR DONDE APUNTA LASTPTR
   4605 3A 00 45      [13]  252     ld      a, (last_obs_ptr)       ;;Esto no apunta bien al last_obs_ptr
   4608 D6 0A         [ 7]  253     sub     #obstacle_size
   460A 32 00 45      [13]  254     ld      (last_obs_ptr), a
                            255 
...
Hexadecimal [16-Bits]
                            ...
                            257     
   460D 2A 02 45      [16]  258     ld      hl, (num_obstacles)
   4610 2B            [ 6]  259     dec     hl
   4611 22 02 45      [16]  260     ld      (num_obstacles), hl
                            261 
                            262     
   4614 2A 03 45      [16]  263     ld      hl, (num_obstacles_marcados) 
   4617 7D            [ 4]  264     ld      a, l
   4618 3D            [ 4]  265     dec     a
   4619 32 03 45      [13]  266     ld      (num_obstacles_marcados), a 
   461C FE 00         [ 7]  267     cp      #0
   461E 20 E5         [12]  268     jr      nz, _decrementar
                            269 
                            ...
                            275     
   4620 18 00         [12]  276     jr      _seguir
   4622                     277 _seguir:
   4622 F1            [10]  278     pop     af
   4623 3D            [ 4]  279     dec     a
   4624 C8            [11]  280     ret     z
                            281 
   4625 01 0A 00      [10]  282     ld      bc, #obstacle_size
   4628 DD 09         [15]  283     add     ix, bc
                            284 
                            285     
   462A 18 9C         [12]  286     jr      _destroyloop
   462C C9            [10]  287     ret
                            288 
                            289 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            290 ;;
                            ...
                            292 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   462D                     293 obstacle_getIXPtr::
   462D DD 21 88 45   [14]  294     ld ix, #obstacle
   4631 C9            [10]  295 ret
                            296 
   4632                     297 obstacle_getIYPtr::
   4632 FD 21 88 45   [14]  298     ld iy, #obstacle
   4636 C9            [10]  299 ret
                            300 
   4637                     301 get_lastObsPtr::
   4637 DD 2A 00 45   [20]  302     ld ix, (last_obs_ptr)
   463B C9            [10]  303 ret 
                            304 
                            305 
                            306 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
Hexadecimal [16-Bits]
                            ...
                            312 
   463C                     313 set_y_last_obstacle::
   463C DD 21 88 45   [14]  314 ld ix, #obstacle
   4640 DD 77 01      [19]  315 ld h_y(ix), a
   4643 C9            [10]  316 ret
                            317 
   4644                     318 set_x_last_obstacle::
   4644 DD 21 88 45   [14]  319 ld ix, #obstacle
   4648 DD 77 00      [19]  320 ld h_x(ix), a
   464B C9            [10]  321 ret
                            322 
                            323 
   464C                     324 set_y_wave::
   464C DD 21 A6 45   [14]  325 ld ix, #wave_obstacle
   4650 DD 77 01      [19]  326 ld h_y(ix), a
   4653 C9            [10]  327 ret
                            328 
   4654                     329 set_y_ghost::
   4654 DD 21 9C 45   [14]  330 ld ix, #moving_obstacle
   4658 DD 77 01      [19]  331 ld h_y(ix), a
   465B C9            [10]  332 ret
                            333 
   465C                     334 set_y_bigobstacle::
   465C DD 21 92 45   [14]  335 ld ix, #big_obstacle
   4660 DD 77 01      [19]  336 ld h_y(ix), a
   4663 C9            [10]  337 ret
                            338 
                            339 
                            340 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            ...
                            345 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            346 
   4664                     347 obs_doForAll::
   4664 3A 02 45      [13]  348     ld  a, (num_obstacles)
   4667 DD 21 37 44   [14]  349     ld  ix, #obstacle_array
   466B 22 70 46      [16]  350     ld  (metodo), hl 
                            351 
   466E                     352 buc:
   466E F5            [11]  353     push af
                     0239   354     metodo = . + 1
   466F CD A0 65      [17]  355     call sys_render_draw
   4672 F1            [10]  356     pop af
   4673 01 0A 00      [10]  357     ld bc, #obstacle_size
   4676 DD 09         [15]  358     add ix, bc 
                            359 
   4678 3D            [ 4]  360     dec a
   4679 20 F3         [12]  361     jr nz, buc
                            362 
   467B C9            [10]  363     ret
                            364 
                            365 
...
Hexadecimal [16-Bits]
                            ...
                            373 
   467C                     374 obs_create::
   467C ED 5B 00 45   [20]  375     ld de, (last_obs_ptr)
   4680 01 0A 00      [10]  376     ld bc, #obstacle_size
   4683 ED B0         [21]  377     ldir                        ;;Mete los valores a los que apunta hl en la direccion a la que apunta de, tantas veces como diga bc
                            378                                 ;;Incremento el contador de entidades y guardo su valor
   4685 3A 02 45      [13]  379     ld a, (num_obstacles)
   4688 3C            [ 4]  380     inc a
   4689 32 02 45      [13]  381     ld (num_obstacles), a
                            382 
   468C 2A 00 45      [16]  383     ld hl, (last_obs_ptr)
   468F 01 0A 00      [10]  384     ld bc, #obstacle_size
   4692 09            [11]  385     add hl, bc
   4693 22 00 45      [16]  386     ld (last_obs_ptr), hl
                            387 
   4696 C9            [10]  388 ret
                            389 
                            390 
   ...
   4697                     400 generar1entidad::
   4697 DD 21 88 45   [14]  401     ld ix, #obstacle
   469B 21 88 45      [10]  402     ld hl, #obstacle
   469E CD 7C 46      [17]  403     call obs_create
   46A1 3A 6C 47      [13]  404     ld a, (level_obstacles)
   46A4 3C            [ 4]  405     inc a 
   46A5 32 6C 47      [13]  406     ld (level_obstacles),a
   46A8 C9            [10]  407 ret
   46A9                     408 generar1entidadWave::
   46A9 DD 21 A6 45   [14]  409     ld ix, #wave_obstacle
   46AD 21 A6 45      [10]  410     ld hl, #wave_obstacle
   46B0 CD 7C 46      [17]  411     call obs_create
   46B3 3A 6C 47      [13]  412     ld a, (level_obstacles)
   46B6 3C            [ 4]  413     inc a 
   46B7 32 6C 47      [13]  414     ld (level_obstacles),a
   46BA C9            [10]  415 ret
                            416 
   46BB                     417 generar1entidadGhost::
   46BB DD 21 9C 45   [14]  418     ld ix, #moving_obstacle
   46BF 21 9C 45      [10]  419     ld hl, #moving_obstacle
   46C2 CD 7C 46      [17]  420     call obs_create
   46C5 3A 6C 47      [13]  421     ld a, (level_obstacles)
...
Hexadecimal [16-Bits]
   ...
   46C8 3C            [ 4]  422     inc a 
   46C9 32 6C 47      [13]  423     ld (level_obstacles),a
   46CC C9            [10]  424 ret
                            425 
   46CD                     426 generar1entidadBig::
   46CD DD 21 92 45   [14]  427     ld ix, #big_obstacle
   46D1 21 92 45      [10]  428     ld hl, #big_obstacle
   46D4 CD 7C 46      [17]  429     call obs_create
   46D7 3A 6C 47      [13]  430     ld a, (level_obstacles)
   46DA 3C            [ 4]  431     inc a 
   46DB 32 6C 47      [13]  432     ld (level_obstacles),a
   46DE C9            [10]  433 ret
                            434 
                            435 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            436 ;;
                            ...
                            442 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   46DF                     443 obs_destroy_all::
   46DF CD B1 45      [17]  444 call obs_getObstacleArray_IX
   46E2 CD BB 45      [17]  445 call obs_getNumObstacles_A
   46E5 21 37 44      [10]  446 ld      hl, #obstacle_array ;; Como vamos a destruir todo, el last_obs_ptr apuntara al principio del array
   46E8 22 00 45      [16]  447 ld      (last_obs_ptr), hl  
   46EB                     448 _destroyallloop:
   46EB DD 36 00 00   [19]  449     ld      h_x(ix), #0x00
   46EF DD 36 01 00   [19]  450     ld      h_y(ix), #0x00
   46F3 DD 36 02 00   [19]  451     ld      h_w(ix), #0x00
   46F7 DD 36 03 00   [19]  452     ld      h_h(ix), #0x00
   46FB DD 36 04 00   [19]  453     ld      h_vx(ix), #0x00
   46FF DD 36 05 00   [19]  454     ld      h_vy(ix), #0x00
   4703 DD 36 06 00   [19]  455     ld      h_color(ix), #0x00
   4707 DD 36 07 00   [19]  456     ld      h_salto(ix), #0x00
   470B DD 36 08 00   [19]  457     ld      h_posicion(ix), #0x00
                            458     
   470F 2A 02 45      [16]  459     ld      hl, (num_obstacles)
   4712 2B            [ 6]  460     dec     hl
   4713 22 02 45      [16]  461     ld      (num_obstacles), hl
   4716 3D            [ 4]  462     dec     a
   4717 C8            [11]  463     ret     z
   4718 01 0A 00      [10]  464     ld      bc, #obstacle_size
   471B DD 09         [15]  465     add     ix, bc
   471D 18 CC         [12]  466     jr      _destroyallloop
                            467     
   471F C9            [10]  468     ret
