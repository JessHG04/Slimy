...
Hexadecimal [16-Bits]
   ...
   6125 FB                   25     .db     #-5         
   6126 FB                   26     .db     #-5          ;;20
   6127 FC FC                27     .db     #-4, #-4           ;;12
   6129 FC FC FC FD FD       28     .db     #-4, #-4, #-4, #-3, #-3      ;;15
   612E FE FE FE FE FE       29     .db     #-2, #-2, #-2, #-2, #-2      ;;10       
   6133 FE FE FE FE FE       30     .db     #-2, #-2, #-2, #-2, #-2
   6138 FF FF FF FF FF FF    31     .db     #-1, #-1, #-1, #-1 , #-1, #-1   ;;5           
                             32   
   613E 80                   33     .db     #0x80
                             34   
                             35 
   ...
   613F 06 08 0A             39     .db     #6,     #8,     #10
   6142 0C 0C 0E             40     .db     #12,    #12,    #14
                             41 
   6145 80                   42     .db     #0x80
                             43 
                             44 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             ...
                             50 
                             51 
   6146                      52 sys_physics_jump_control::
   6146 CD 93 43      [17]   53     call hero_getIXPtr  
                             54 
                             55     ;;Controla si ahora mismo estamos saltando                
   6149 DD 7E 07      [19]   56     ld a, h_salto(ix)                   ;; Cargo el status del salto en a
   614C FE FF         [ 7]   57     cp #-1                              ;; -1 indica que el heroe no esta saltando
   614E C8            [11]   58     ret z                               ;; Si A == -1 no salta
                             59 
   614F DD 7E 08      [19]   60     ld a, h_posicion(ix)                ;; Cargo la posicion del heroe en a (arriba o abajo)
   6152 FE 0A         [ 7]   61     cp #0x0A                            ;; 0x0A indica que el heroe esta arriba ya
   6154 C8            [11]   62     ret z                               ;; Si ya esta arriba, no podemos seguir saltando
                             63     
                             64 
                             65     ;;Get jump value
   6155 DD 7E 07      [19]   66     ld a, h_salto(ix)                   ;; Cargo en a el status del salto
   6158 21 25 61      [10]   67     ld      hl, #jumptable              ;; HL apunta al inicio de la tabla de salto
   615B 4F            [ 4]   68     ld      c,  a                       ;; Cargo en c el contenido de a y en b cargo un 0 para que el registro
   615C 06 00         [ 7]   69     ld      b,  #0                      ;; BC sea igual a A (Offset)
   615E 09            [11]   70     add     hl, bc                      ;; HL += BC incremento hl lo que me indica bc para ir desplazandome por la tabla de salto
                             71 
                             72 
                             73     ;; Check End of jumping
   615F 7E            [ 7]   74     ld      a, (hl)                     ;; Cargo en a el contenido de la direccion de memoria que indica hl
   6160 FE 80         [ 7]   75     cp      #0x80                       ;; Si es un 80 querra decir que ya hemos terminado de leer la tabla de salto y ya podemos parar
   6162 28 10         [12]   76     jr      z, sys_physics_end_of_jump  ;; Dejo de leer la tabla de salto y llamo al manejador de fin de salto
                             77 
...
Hexadecimal [16-Bits]
                             ...
                             78 
                             79     ;; Do Jump Movement
   6164 47            [ 4]   80     ld      b, a                        ;; A = Jump Movement // A tiene el contenido de la direccion de memoria de HL (sera un valor de la tabla de salto)
   6165 DD 7E 01      [19]   81     ld      a, h_y(ix)                  ;; a = Posicion y del heroe
   6168 80            [ 4]   82     add     b                           ;; Le sumo a la posicion del heroe el valor de la tabla de salto (que esta almacenado en b)
   6169 DD 77 01      [19]   83     ld      h_y(ix), a                  ;; Cambio la posicion del heroe cargando el contenido del registro a
                             84     
                             85 
                             86 
                             87     ;; Increment Hero Jump Index
   616C DD 7E 07      [19]   88     ld      a, h_salto(ix)              ;; A = Hero_jump
   616F 3C            [ 4]   89     inc     a                           ;; Incremento a para leer el siguiente valor de la tabla jump
   6170 DD 77 07      [19]   90     ld      h_salto(ix), a              ;; Cargo el contenido del status de salto en a
   6173 C9            [10]   91 ret
                             92 
                             93 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             94 ;;
                             ...
                             97 ;;
                             98 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   6174                      99 sys_physics_end_of_jump::
   6174 3E FF         [ 7]  100     ld    a,                #-1
   6176 DD 77 07      [19]  101     ld    h_salto(ix),      a 
                            102 
                            103     ;;Controla si estamos en la parte de arriba
   6179 DD 7E 01      [19]  104     ld              a,      h_y(ix)
   617C FE 76         [ 7]  105     cp #0x76                     ;;Si mi posicion es 0x51 en el eje y, establezco el _posicion a 0x0A (arriba)
   617E CC 97 61      [17]  106     call z, sys_physics_estoy_arriba
   6181 C9            [10]  107 ret
                            108 
                            109 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            110 ;;
                            ...
                            112 ;;
                            113 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   6182                     114 sys_physics_startJump::
   6182 CD 93 43      [17]  115     call    hero_getIXPtr 
   6185 DD 7E 07      [19]  116     ld      a, h_salto(ix)
   6188 FE FF         [ 7]  117     cp      #-1                         ;; Comprueba que el h_salto sea -1 para que, si no esta saltando, siga con la funcion y el salto se inicie
   618A C0            [11]  118     ret     nz                          ;; Si es un 0 seguimos con la funcion (Si NO es un 0, no seguimos con la funcion)
                            119 
   618B DD 7E 08      [19]  120     ld      a, h_posicion(ix)           ;;Si el personaje ya esta arriba no iniciamos el salto
   618E FE 0A         [ 7]  121     cp      #0x0A
   6190 C8            [11]  122     ret     z
   ...
   6191 3E 00         [ 7]  125     ld      a       , #0
   6193 DD 77 07      [19]  126     ld  h_salto(ix) , a
                            127 
   6196 C9            [10]  128     ret
                            129 
                            130 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
Hexadecimal [16-Bits]
                            ...
                            133 ;;
                            134 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   6197                     135 sys_physics_estoy_arriba::
   6197 CD 93 43      [17]  136       call hero_getIXPtr
   619A 3E 0A         [ 7]  137       ld a, #0x0A
   619C DD 77 08      [19]  138       ld h_posicion(ix), a
   619F C9            [10]  139   ret
                            140 
                            141 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            142 ;;
                            ...
                            145 ;;
                            146 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   61A0                     147 sys_physics_move_hero_right::
                            148 
   61A0 DD 7E 00      [19]  149         ld      a, h_x(ix)
   61A3 FE 48         [ 7]  150         cp      #80-8               ;;Comprueba el limite derecho (Tamanyo de la pantalla - Tamanyo del heroe)
   61A5 28 04         [12]  151         jr      z, do_not_move_r        ;;Posicion x heroe == limite de pantalla, asi que NO se mueve a la derecha
                            152 
                            153             ;; Move right
   61A7 3C            [ 4]  154             inc     a 
   61A8 DD 77 00      [19]  155             ld      h_x(ix), a          ;;Actualizo la posicion del heroe
                            156         
   61AB                     157         do_not_move_r:
   61AB C9            [10]  158 ret
                            159 
                            160 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            161 ;;
                            ...
                            164 ;;
                            165 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   61AC                     166 sys_physics_move_hero_left::
                            167 
   61AC DD 7E 00      [19]  168         ld      a, h_x(ix)
   61AF FE 00         [ 7]  169         cp      #00                     ;;Comprueba el limite izquierdo (inicio de la pantalla)
   61B1 28 04         [12]  170         jr      z, do_not_move_l        ;; Si el heroe esta en el limite, no se mueve mas hacia la izquierda
                            171         
                            172             ;;Move left
   61B3 3D            [ 4]  173             dec     a 
   61B4 DD 77 00      [19]  174             ld      h_x(ix), a
                            175 
   61B7                     176         do_not_move_l: 
                            177 
   61B7 C9            [10]  178 ret
                            179 
                            180 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            ...
                            184 ;;
                            185 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   61B8                     186 sys_physics_fall_control::
   61B8 CD 93 43      [17]  187     call hero_getIXPtr  
...
Hexadecimal [16-Bits]
   ...
   61BB DD 7E 07      [19]  190     ld a, h_salto(ix)                   ;; Hero jump status
   61BE FE FF         [ 7]  191     cp #-1                              ;; -1 indica que el heroe no esta saltando
   61C0 C8            [11]  192     ret z                               ;; Si A == -1 no salta
                            193 
   61C1 DD 7E 08      [19]  194     ld a, h_posicion(ix)
   61C4 FE 0B         [ 7]  195     cp #0x0B                            ;; Si nuestra posicion es 0x0B significa que ya estamos abajo
   61C6 C8            [11]  196     ret z                               ;; y por tanto no podemos caer mas
                            197 
                            198     ;;Get jump value
   61C7 DD 7E 07      [19]  199     ld a, h_salto(ix)                   ;; Hero jump status
   61CA 21 3F 61      [10]  200     ld      hl, #falltable              ;; HL apunta al inicio de la tabla de jum
   61CD 4F            [ 4]  201     ld      c,  a
   61CE 06 00         [ 7]  202     ld      b,  #0                      ;; BC = A (Offset)
   61D0 09            [11]  203     add     hl, bc                      ;; HL += BC
                            204 
                            205     ;; Check End of jumping
   61D1 7E            [ 7]  206     ld      a, (hl)
   61D2 FE 80         [ 7]  207     cp      #0x80                       ;; Jump Value == 0
   61D4 28 25         [12]  208     jr      z, sys_physics_end_of_fall
                            209 
                            210     ;; Do Jump Movement
   61D6 47            [ 4]  211     ld      b, a                        ;; A = Jump Movement
   61D7 DD 7E 01      [19]  212     ld      a, h_y(ix)                  ;; a = Posicion y del heroe
   61DA 80            [ 4]  213     add     b                           ;; A+= 
   61DB DD 77 01      [19]  214     ld      h_y(ix), a
                            215     
                            216 ;; Increment Hero Fall Index
   61DE DD 7E 07      [19]  217     ld      a, h_salto(ix)              ;; A = Hero_jump                         ;;Si ha llegado arriba del todo no sigue saltando
   61E1 3C            [ 4]  218     inc     a 
   61E2 DD 77 07      [19]  219     ld      h_salto(ix), a
   61E5 C9            [10]  220 ret
                            221 
   61E6                     222 sys_physics_startFall::
   61E6 CD 93 43      [17]  223     call    hero_getIXPtr 
   61E9 DD 7E 07      [19]  224     ld      a, h_salto(ix)
   61EC FE FF         [ 7]  225     cp      #-1                         ;; Comprueba que el h_salto sea -1 para que, si no esta saltando, siga con la funcion y el salto se inicie
   61EE C0            [11]  226     ret     nz                          ;; Si es un 0 seguimos con la funcion (Si NO es un 0, no seguimos con la funcion)
                            227 
   61EF DD 7E 08      [19]  228     ld      a, h_posicion(ix)           ;;Si el personaje ya esta arriba no iniciamos el salto
   61F2 FE 0B         [ 7]  229     cp      #0x0B
   61F4 C8            [11]  230     ret     z
   ...
   61F5 3E 00         [ 7]  233     ld      a       , #0
   61F7 DD 77 07      [19]  234     ld  h_salto(ix) , a
                            235 
   61FA C9            [10]  236     ret
                            237 
                            238 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
Hexadecimal [16-Bits]
                            ...
                            243 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   61FB                     244 sys_physics_end_of_fall::
   61FB 3E FF         [ 7]  245     ld      a,          #-1
   61FD DD 77 07      [19]  246     ld    h_salto(ix),  a 
                            247                                       
   6200 DD 7E 01      [19]  248     ld a, h_y(ix)
   6203 FE B4         [ 7]  249     cp #0xB4                            ;; Comprueba si estoy en el carril de abajo (posicion 0xB4)
   6205 CC 09 62      [17]  250     call z, sys_physics_estoy_abajo
   6208 C9            [10]  251 ret
                            252 
                            253 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            254 ;;;;
                            ...
                            257 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   6209                     258 sys_physics_estoy_abajo::
   6209 CD 93 43      [17]  259       call hero_getIXPtr
   620C 3E 0B         [ 7]  260       ld a, #0x0B
   620E DD 77 08      [19]  261       ld h_posicion(ix), a
   6211 C9            [10]  262   ret
                            263 
                            264 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            265 ;;;;
                            ...
                            273 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   6212                     274 sys_collision_check::
   6212 CD 98 43      [17]  275 call hero_getIYPtr
                            276     ;; if ( A < B) no collision
                            277     ;; A = e_x(ix) + e_w(ix)
                            278     ;; B = e_x(iy) 
                            279     ;; if ( e_x(ix) + e_w(ix)  <  e_x(iy)) ;;No collision
                            280     ;; if ( e_x(ix) + e_w(ix)  -  e_x(iy)) < 0 ;;No collision
   6215 DD 7E 00      [19]  281     ld          a, h_x(ix)
   6218 DD 86 02      [19]  282     add         h_w(ix)       
   621B FD 96 00      [19]  283     sub         h_x(iy)
   621E 38 31         [12]  284     jr          c, __no_collision
                            285 
   ...
   6220 FD 7E 00      [19]  291     ld          a, h_x(iy)
   6223 FD 86 02      [19]  292     add         h_w(iy)       
   6226 DD 96 00      [19]  293     sub         h_x(ix)
   6229 38 26         [12]  294     jr          c, __no_collision
                            295 
                            296    ;;EL CODIGO ANTERIOR ERA EN EL EJE X, AHORA EN EL EJE Y
   622B DD 7E 01      [19]  297     ld          a, h_y(ix)
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 64.
Hexadecimal [16-Bits]



   622E DD 86 03      [19]  298     add         h_h(ix)       
   6231 FD 96 01      [19]  299     sub         h_y(iy)
   6234 38 1B         [12]  300     jr          c, __no_collision
                            301 
                            302     
   6236 FD 7E 01      [19]  303     ld          a, h_y(iy)
   6239 FD 86 03      [19]  304     add         h_h(iy)       
   623C DD 96 01      [19]  305     sub         h_y(ix)
   623F 38 10         [12]  306     jr          c, __no_collision
                            307 
                            308   ;;SI HAY COLISION LLEGA AQUI
                            309 
   6241 DD 36 05 10   [19]  310     ld      h_vy(ix), #0x10
   6245 3E 00         [ 7]  311     ld a, #0
   6247 32 6D 60      [13]  312     ld (_juego_pausado), a ;;Pausa el timer si hay colision
   624A CD 7A 48      [17]  313     call man_game_restart;;Reinicia el heroe y limpia obstaculos
   624D CD 4D 47      [17]  314     call man_gameover_run;;Invoca la pantalla gameover
                            315 
   6250 C9            [10]  316     ret
                            317 
   6251                     318 __no_collision:
                            319     
   6251 C9            [10]  320 ret
