...
Hexadecimal [16-Bits]
   ...
   43F0 CD 6D 47      [17]   36    call man_game_init   
   43F3                      37    init_game::
   43F3 CD 05 60      [17]   38    call man_menu_run             ;; Bucle infinito hasta que se pulse espacio 
   43F6 CD 88 43      [17]   39    call hero_init                ;; Inicializa al heroe con los datos por defecto. Lo mismo con el obstaculo
   43F9 CD 88 45      [17]   40    call obstacle_init  
                             41 
   43FC                      42 _lvl_control::;;Inicia el nivel en el que nos encontramos
                             43 
   43FC CD 7C 47      [17]   44    call man_game_init_lvl
                             45 
   43FF                      46 loop:
                             47     
                             48    ;;Heroe
   43FF CD 9C 63      [17]   49    call sys_render_clear_hero
   4402 CD 7E 43      [17]   50    call hero_update              ;;Incluye la función de salto, de keyboard input y de caída
   4405 CD 6C 63      [17]   51    call sys_render_update_hero
                             52    ;;Comprobacion si existen obstaculos
   4408 CD BB 45      [17]   53    call obs_getNumObstacles_A
   440B FE 00         [ 7]   54    cp #0
   440D 28 1E         [12]   55    jr z, no_enem
                             56 
                             57    ;;Obstaculos
   440F 21 6B 65      [10]   58    ld hl, #sys_render_clear_obstacle
   4412 CD 64 46      [17]   59    call obs_doForAll
   4415 21 04 45      [10]   60    ld hl, #position_update
   4418 CD 64 46      [17]   61    call obs_doForAll
   441B 21 A6 63      [10]   62    ld hl, #sys_render_update_obstacle
   441E CD 64 46      [17]   63    call obs_doForAll
                             64    ;;Colisiones
   4421 CD 98 43      [17]   65    call hero_getIYPtr
   4424 21 12 62      [10]   66    ld hl, #sys_collision_check
   4427 CD 64 46      [17]   67    call obs_doForAll
                             68 
   442A CD BF 45      [17]   69    call obs_destroy
                             70    
                             71 
   442D                      72 no_enem:
                             73 
   442D CD 95 48      [17]   74    call man_game_check_level;;Controla el nivel en el que nos encontramos
                             75 
   4430 CD 65 6A      [17]   76    call cpct_waitVSYNC_asm
   4433 76            [ 4]   77    halt
   4434 76            [ 4]   78    halt
   4435 18 C8         [12]   79    jr    loop
