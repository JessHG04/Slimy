...
Hexadecimal [16-Bits]
                             ...
                             23 .include "hero.h.s";;orovisional
                              1 ;;----------------------------------LICENSE NOTICE-----------------------------------------------------
                              2 ;;Slimy is a challenging videogame made for Amstrad CPC
                              3 ;;    Copyright (C) 2020  Maria del Rosario Fernandez Garcia // David Llopis Romero // Jessica Hernandez Gomez
                              4 ;;
...
Hexadecimal [16-Bits]
                             ...
                             24 .include "obstacles.h.s";;orovisional
                              1 ;;----------------------------------LICENSE NOTICE-----------------------------------------------------
                              2 ;;Slimy is a challenging videogame made for Amstrad CPC
                              3 ;;    Copyright (C) 2020  Maria del Rosario Fernandez Garcia // David Llopis Romero // Jessica Hernandez Gomez
                              4 ;;
...
Hexadecimal [16-Bits]
                             ...
                             32 ;;=======================================================================
                             33 
   601A 50 72 65 73 73 20    34 str_press3:  .asciz  "Press start to next level"
        73 74 61 72 74 20
        74 6F 20 6E 65 78
        74 20 6C 65 76 65
        6C 00
                             ...
                             40 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             41 ;;INIT
                             42 ;;      Initializes the main menu
                             43 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   6034                      44 man_nextlevel_init::
                             45 
                             46     ;;Press String
   6034 21 04 00      [10]   47     ld      hl, #0x0004
   6037 CD 98 73      [17]   48     call    cpct_setDrawCharM0_asm
   603A 11 00 C0      [10]   49     ld      de, #0xC000
   603D 0E 00         [ 7]   50     ld       c, #0x00
   603F 06 90         [ 7]   51     ld       b, #0x90
   6041 CD BB 73      [17]   52     call    cpct_getScreenPtr_asm
   6044 FD 21 1A 60   [14]   53     ld      iy, #str_press3
   6048 CD 31 69      [17]   54     call    cpct_drawStringM0_asm
                             55     
   604B C9            [10]   56 ret
                             57 
                             58 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             59 ;;RUN
                             60 ;;      Runs the menu until finished
                             61 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             62 
   604C                      63 man_nextlevel_run::
   604C CD 34 60      [17]   64     call man_nextlevel_init
   604F CD CA 60      [17]   65     call timer_value   ;;Coloca el contador a un valor por defecto para que no salta la comprobacion con 0
   6052                      66     _control:
                             67     ;;Key control
   6052 CD D7 73      [17]   68     call    cpct_scanKeyboard_asm
   6055 21 05 80      [10]   69     ld      hl, #Key_Space
   6058 CD 08 69      [17]   70     call    cpct_isKeyPressed_asm
   605B 28 F5         [12]   71     jr      z, _control
   605D 21 01 00      [10]   72     ld hl, #1
                             73 
   6060 CD EC 65      [17]   74     call sys_render_clear_screen
   6063 CD 7A 48      [17]   75     call man_game_restart
   6066 C3 FC 43      [10]   76     jp _lvl_control  ;; Volver al menu principal tras pulsar espacio ;;EN UN FUTURO CAMBIAR AL SIGUIENTE NIVEL
   6069 C9            [10]   77 ret
