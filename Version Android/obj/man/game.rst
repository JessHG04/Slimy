...
Hexadecimal [16-Bits]
                             ...
                             16 ;;    along with this program.  If not, see <https://www.gnu.org/licenses/>.
                             17 ;;------------------------------------------------------------------------------------------------------
                             18 .module Timer_System
                             19 
                             20 ;;PUBLIC
                             21 
                             22 .globl timer_value
                             23 
                             24 .globl timer_menos1s
                             25 
                             26 .globl timer_control
                             27 
                             28 .globl timer_render
                             29 
                             30 .globl timer_clear
...
Hexadecimal [16-Bits]
                             ...
                             16 ;;    along with this program.  If not, see <https://www.gnu.org/licenses/>.
                             17 ;;------------------------------------------------------------------------------------------------------
                             18 .module Interrup_System
                             19 
                             20 ;;PUBLIC
                             21 
                             22 .globl int_handler
                             23 
                             24 .globl set_int_handler
                             25 
...
Hexadecimal [16-Bits]
                             ...
                             16 ;;    along with this program.  If not, see <https://www.gnu.org/licenses/>.
                             17 ;;------------------------------------------------------------------------------------------------------
                             18 .globl man_gameover_init
                             19 .globl man_gameover_run
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 66.
Hexadecimal [16-Bits]



                             28 .include "man/win.h.s"
                              1 ;;----------------------------------LICENSE NOTICE-----------------------------------------------------
                              2 ;;Slimy is a challenging videogame made for Amstrad CPC
                              3 ;;    Copyright (C) 2020  Maria del Rosario Fernandez Garcia // David Llopis Romero // Jessica Hernandez Gomez
                              4 ;;
                             ...
                             16 ;;    along with this program.  If not, see <https://www.gnu.org/licenses/>.
                             17 ;;------------------------------------------------------------------------------------------------------
                             18 .globl man_win_init
                             19 .globl man_win_run
...
Hexadecimal [16-Bits]
                             ...
                             29 .globl _song_demo
   476B 01                   30 level:: .db 1
   476C 00                   31 level_obstacles:: .db 0
                             32 
   476D                      33 man_game_init::;;Empieza el juego    
   476D CD 9F 4A      [17]   34     call set_int_handler          ;; Coloca la funcion que controla las interrupciones en el registro HL     
   4770 11 40 00      [10]   35     ld de, #_song_demo
   4773 CD C6 71      [17]   36     call cpct_akp_musicInit_asm
   4776 3E 00         [ 7]   37     ld a, #0
   4778 32 6D 60      [13]   38     ld (_juego_pausado), a  
                             39 
   477B C9            [10]   40 ret
                             41 
   477C                      42 man_game_init_lvl:: ;;Comprueba en que nivel estamos lo inicializa y despausa el contador
                             43     ;;Resetea el numero de obstaculos creados en el nivel
   477C 3A 6B 47      [13]   44     ld a, (level)
   477F FE 01         [ 7]   45     cp #1
   4781 CC 86 49      [17]   46         call z, man_game_init_lvl_123
   4784 3A 6B 47      [13]   47     ld a, (level)
   4787 FE 02         [ 7]   48     cp #2
   4789 CC 86 49      [17]   49         call z, man_game_init_lvl_123
   478C 3A 6B 47      [13]   50     ld a, (level)
   478F FE 03         [ 7]   51     cp #3
   4791 CC 86 49      [17]   52         call z, man_game_init_lvl_123
   4794 3A 6B 47      [13]   53     ld a, (level)
   4797 FE 04         [ 7]   54     cp #4
   4799 CC 86 49      [17]   55         call z, man_game_init_lvl_123
   479C 3A 6B 47      [13]   56     ld a, (level)
   479F FE 05         [ 7]   57     cp #5
   47A1 CC 86 49      [17]   58         call z, man_game_init_lvl_123
   47A4 3A 6B 47      [13]   59     ld a, (level)
   47A7 FE 06         [ 7]   60     cp #6
   47A9 CC 86 49      [17]   61         call z, man_game_init_lvl_123
   47AC 3A 6B 47      [13]   62     ld a, (level)
   47AF FE 07         [ 7]   63     cp #7
   47B1 CC 86 49      [17]   64         call z, man_game_init_lvl_123
   47B4 3A 6B 47      [13]   65     ld a, (level)
   47B7 FE 08         [ 7]   66     cp #8
   47B9 CC 86 49      [17]   67         call z, man_game_init_lvl_123
   47BC 3A 6B 47      [13]   68     ld a, (level)
   47BF FE 09         [ 7]   69     cp #9
   47C1 CC 86 49      [17]   70         call z, man_game_init_lvl_123
   47C4 3A 6B 47      [13]   71     ld a, (level)
   47C7 FE 0A         [ 7]   72     cp #10
   47C9 CC 86 49      [17]   73         call z, man_game_init_lvl_123
   47CC 3A 6B 47      [13]   74     ld a, (level)
   47CF FE 0B         [ 7]   75     cp #11
   47D1 CC DA 49      [17]   76         call z, man_game_init_lvl_456
   47D4 3A 6B 47      [13]   77     ld a, (level)
   47D7 FE 0C         [ 7]   78     cp #12
   47D9 CC DA 49      [17]   79         call z, man_game_init_lvl_456
   47DC 3A 6B 47      [13]   80     ld a, (level)
   47DF FE 0D         [ 7]   81     cp #13
   47E1 CC DA 49      [17]   82         call z, man_game_init_lvl_456
   47E4 3A 6B 47      [13]   83     ld a, (level)
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 68.
Hexadecimal [16-Bits]



   47E7 FE 0E         [ 7]   84     cp #14
   47E9 CC DA 49      [17]   85         call z, man_game_init_lvl_456
   47EC 3A 6B 47      [13]   86     ld a, (level)
   47EF FE 0F         [ 7]   87     cp #15
   47F1 CC DA 49      [17]   88         call z, man_game_init_lvl_456
   47F4 3A 6B 47      [13]   89     ld a, (level)
   47F7 FE 10         [ 7]   90     cp #16
   47F9 CC DA 49      [17]   91         call z, man_game_init_lvl_456
   47FC 3A 6B 47      [13]   92     ld a, (level)
   47FF FE 11         [ 7]   93     cp #17
   4801 CC DA 49      [17]   94         call z, man_game_init_lvl_456
   4804 3A 6B 47      [13]   95     ld a, (level)
   4807 FE 12         [ 7]   96     cp #18
   4809 CC DA 49      [17]   97         call z, man_game_init_lvl_456
   480C 3A 6B 47      [13]   98     ld a, (level)
   480F FE 13         [ 7]   99     cp #19
   4811 CC DA 49      [17]  100         call z, man_game_init_lvl_456
   4814 3A 6B 47      [13]  101     ld a, (level)
   4817 FE 14         [ 7]  102     cp #20
   4819 CC DA 49      [17]  103         call z, man_game_init_lvl_456
   481C 3A 6B 47      [13]  104     ld a, (level)
   481F FE 15         [ 7]  105     cp #21
   4821 CC 2E 4A      [17]  106         call z, man_game_init_lvl_789
   4824 3A 6B 47      [13]  107     ld a, (level)
   4827 FE 16         [ 7]  108     cp #22
   4829 CC 2E 4A      [17]  109         call z, man_game_init_lvl_789
   482C 3A 6B 47      [13]  110     ld a, (level)
   482F FE 17         [ 7]  111     cp #23
   4831 CC 2E 4A      [17]  112         call z, man_game_init_lvl_789
   4834 3A 6B 47      [13]  113     ld a, (level)
   4837 FE 18         [ 7]  114     cp #24
   4839 CC 2E 4A      [17]  115         call z, man_game_init_lvl_789
   483C 3A 6B 47      [13]  116     ld a, (level)
   483F FE 19         [ 7]  117     cp #25
   4841 CC 2E 4A      [17]  118         call z, man_game_init_lvl_789
   4844 3A 6B 47      [13]  119     ld a, (level)
   4847 FE 1A         [ 7]  120     cp #26
   4849 CC 2E 4A      [17]  121         call z, man_game_init_lvl_789
   484C 3A 6B 47      [13]  122     ld a, (level)
   484F FE 1B         [ 7]  123     cp #27
   4851 CC 2E 4A      [17]  124         call z, man_game_init_lvl_789
   4854 3A 6B 47      [13]  125     ld a, (level)
   4857 FE 1C         [ 7]  126     cp #28
   4859 CC 2E 4A      [17]  127         call z, man_game_init_lvl_789
   485C 3A 6B 47      [13]  128     ld a, (level)
   485F FE 1D         [ 7]  129     cp #29
   4861 CC 2E 4A      [17]  130         call z, man_game_init_lvl_789
   4864 3A 6B 47      [13]  131     ld a, (level)
   4867 FE 1E         [ 7]  132     cp #30
   4869 CC 2E 4A      [17]  133         call z, man_game_init_lvl_789
   486C 3A 6B 47      [13]  134     ld a, (level)
   486F FE 1F         [ 7]  135     cp #31
                            136 
   4871 CC 04 61      [17]  137         call z, man_win_run
                            138     ;;Despausa el nivel
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 69.
Hexadecimal [16-Bits]



   4874 3E 01         [ 7]  139     ld a, #1
   4876 32 6D 60      [13]  140     ld (_juego_pausado), a
   4879 C9            [10]  141 ret
                            142 
                            143 
                            144 ;; La llamo en el chequeo de colisiones
   487A                     145 man_game_restart::
   487A CD 9D 43      [17]  146     call hero_restart
   487D 3E 00         [ 7]  147     ld a,#0
   487F 32 6C 47      [13]  148     ld (level_obstacles), a
   4882 32 03 45      [13]  149     ld (num_obstacles_marcados),a
   4885 32 6D 60      [13]  150     ld (_juego_pausado), a  
                            151     
                            152  
                            153     
   4888 C9            [10]  154 ret
                            155 
   4889                     156 man_game_reset_level::
   4889 3E 00         [ 7]  157     ld a, #0
   488B 32 6D 60      [13]  158     ld (_juego_pausado), a ;;Pausa el timer si hay colision
   488E CD 7A 48      [17]  159     call man_game_restart;;Reinicia el heroe y limpia obstaculos
   4891 CD 4D 47      [17]  160     call man_gameover_run;;Invoca la pantalla gameover
   4894 C9            [10]  161     ret
                            162 
   4895                     163 man_game_check_level::;;Comprueba en que nivel estamos y controla la creacion de entidades
                            164     ;;Key N control PASAR AL SIGUIENTE NIVEL
                            165     ;;call    cpct_scanKeyboard_asm
                            166     ;;ld      hl, #Key_N
                            167     ;;call    cpct_isKeyPressed_asm
                            168     ;;call      nz, timer_clear
                            169 
                            170     ;;Key R control RESETEA EL NIVEL
                            171     ;;call    cpct_scanKeyboard_asm
                            172     ;;ld      hl, #Key_R
                            173     ;;call    cpct_isKeyPressed_asm
                            174     ;;call      nz, man_game_reset_level
                            175 
                            176 
                            177 
   4895 3A 6B 47      [13]  178     ld a, (level)
   4898 FE 01         [ 7]  179     cp #1
   489A CC AE 4A      [17]  180         call z, man_game_controller_lvl_1
   489D 3A 6B 47      [13]  181     ld a, (level)
   48A0 FE 02         [ 7]  182     cp #2
   48A2 CC 11 4B      [17]  183         call z, man_game_controller_lvl_2
   48A5 3A 6B 47      [13]  184     ld a, (level)
   48A8 FE 03         [ 7]  185     cp #3
   48AA CC AD 4B      [17]  186         call z, man_game_controller_lvl_3
   48AD 3A 6B 47      [13]  187     ld a, (level)
   48B0 FE 04         [ 7]  188     cp #4
   48B2 CC 37 4C      [17]  189         call z, man_game_controller_lvl_4
   48B5 3A 6B 47      [13]  190     ld a, (level)
   48B8 FE 05         [ 7]  191     cp #5
   48BA CC EA 4C      [17]  192         call z, man_game_controller_lvl_5
   48BD 3A 6B 47      [13]  193     ld a, (level)
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 70.
Hexadecimal [16-Bits]



   48C0 FE 06         [ 7]  194     cp #6
   48C2 CC 88 4D      [17]  195         call z, man_game_controller_lvl_6
   48C5 3A 6B 47      [13]  196     ld a, (level)
   48C8 FE 07         [ 7]  197     cp #7
   48CA CC 4A 4E      [17]  198         call z, man_game_controller_lvl_7
   48CD 3A 6B 47      [13]  199     ld a, (level)
   48D0 FE 08         [ 7]  200     cp #8
   48D2 CC F0 4E      [17]  201         call z, man_game_controller_lvl_8
   48D5 3A 6B 47      [13]  202     ld a, (level)
   48D8 FE 09         [ 7]  203     cp #9
   48DA CC A4 4F      [17]  204         call z, man_game_controller_lvl_9
   48DD 3A 6B 47      [13]  205     ld a, (level)
   48E0 FE 0A         [ 7]  206     cp #10
   48E2 CC 50 50      [17]  207         call z, man_game_controller_lvl_10
   48E5 3A 6B 47      [13]  208     ld a, (level)
   48E8 FE 0B         [ 7]  209     cp #11
   48EA CC 2A 51      [17]  210         call z, man_game_controller_lvl_11
   48ED 3A 6B 47      [13]  211     ld a, (level)
   48F0 FE 0C         [ 7]  212     cp #12
   48F2 CC C6 51      [17]  213         call z, man_game_controller_lvl_12
   48F5 3A 6B 47      [13]  214     ld a, (level)
   48F8 FE 0D         [ 7]  215     cp #13
   48FA CC 4C 52      [17]  216         call z, man_game_controller_lvl_13
   48FD 3A 6B 47      [13]  217     ld a, (level)
   4900 FE 0E         [ 7]  218     cp #14
   4902 CC 18 53      [17]  219         call z, man_game_controller_lvl_14
   4905 3A 6B 47      [13]  220     ld a, (level)
   4908 FE 0F         [ 7]  221     cp #15
   490A CC D8 53      [17]  222         call z, man_game_controller_lvl_15
   490D 3A 6B 47      [13]  223     ld a, (level)
   4910 FE 10         [ 7]  224     cp #16
   4912 CC A4 54      [17]  225         call z, man_game_controller_lvl_16
   4915 3A 6B 47      [13]  226     ld a, (level)
   4918 FE 11         [ 7]  227     cp #17
   491A CC 79 55      [17]  228         call z, man_game_controller_lvl_17
   491D 3A 6B 47      [13]  229     ld a, (level)
   4920 FE 12         [ 7]  230     cp #18
   4922 CC 2F 56      [17]  231         call z, man_game_controller_lvl_18
   4925 3A 6B 47      [13]  232     ld a, (level)
   4928 FE 13         [ 7]  233     cp #19
   492A CC EF 56      [17]  234         call z, man_game_controller_lvl_19
   492D 3A 6B 47      [13]  235     ld a, (level)
   4930 FE 14         [ 7]  236     cp #20
   4932 CC B5 57      [17]  237         call z, man_game_controller_lvl_20
   4935 3A 6B 47      [13]  238     ld a, (level)
   4938 FE 15         [ 7]  239     cp #21
   493A CC 7E 58      [17]  240         call z, man_game_controller_lvl_21
   493D 3A 6B 47      [13]  241     ld a, (level)
   4940 FE 16         [ 7]  242     cp #22
   4942 CC F4 58      [17]  243         call z, man_game_controller_lvl_22
   4945 3A 6B 47      [13]  244     ld a, (level)
   4948 FE 17         [ 7]  245     cp #23
   494A CC 98 59      [17]  246         call z, man_game_controller_lvl_23
   494D 3A 6B 47      [13]  247     ld a, (level)
   4950 FE 18         [ 7]  248     cp #24
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 71.
Hexadecimal [16-Bits]



   4952 CC 36 5A      [17]  249         call z, man_game_controller_lvl_24
   4955 3A 6B 47      [13]  250     ld a, (level)
   4958 FE 19         [ 7]  251     cp #25
   495A CC FC 5A      [17]  252         call z, man_game_controller_lvl_25
   495D 3A 6B 47      [13]  253     ld a, (level)
   4960 FE 1A         [ 7]  254     cp #26
   4962 CC BC 5B      [17]  255         call z, man_game_controller_lvl_26
   4965 3A 6B 47      [13]  256     ld a, (level)
   4968 FE 1B         [ 7]  257     cp #27
   496A CC 9D 5C      [17]  258         call z, man_game_controller_lvl_27
   496D 3A 6B 47      [13]  259     ld a, (level)
   4970 FE 1C         [ 7]  260     cp #28
   4972 CC 71 5D      [17]  261         call z, man_game_controller_lvl_28
   4975 3A 6B 47      [13]  262     ld a, (level)
   4978 FE 1D         [ 7]  263     cp #29
   497A CC 51 5E      [17]  264         call z, man_game_controller_lvl_29
   497D 3A 6B 47      [13]  265     ld a, (level)
   4980 FE 1E         [ 7]  266     cp #30
   4982 CC 13 5F      [17]  267         call z, man_game_controller_lvl_30
   4985 C9            [10]  268 ret
                            269 
                            270 ;;GAMES INITS
                            271 
   4986                     272 man_game_init_lvl_123::
   4986 CD 05 66      [17]  273     call sys_render_update_bginit123
   4989 3A 6B 47      [13]  274     ld a, (level)
   498C FE 01         [ 7]  275     cp #1
   498E CC 38 66      [17]  276         call z, sys_render_draw_stlvl1
   4991 3A 6B 47      [13]  277     ld a, (level)
   4994 FE 02         [ 7]  278     cp #2
   4996 CC 50 66      [17]  279         call z, sys_render_draw_stlvl2
   4999 3A 6B 47      [13]  280     ld a, (level)
   499C FE 03         [ 7]  281     cp #3
   499E CC 68 66      [17]  282         call z, sys_render_draw_stlvl3
   49A1 3A 6B 47      [13]  283     ld a, (level)
   49A4 FE 04         [ 7]  284     cp #4
   49A6 CC 80 66      [17]  285         call z, sys_render_draw_stlvl4
   49A9 3A 6B 47      [13]  286     ld a, (level)
   49AC FE 05         [ 7]  287     cp #5
   49AE CC 98 66      [17]  288         call z, sys_render_draw_stlvl5
   49B1 3A 6B 47      [13]  289     ld a, (level)
   49B4 FE 06         [ 7]  290     cp #6
   49B6 CC B0 66      [17]  291         call z, sys_render_draw_stlvl6
   49B9 3A 6B 47      [13]  292     ld a, (level)
   49BC FE 07         [ 7]  293     cp #7
   49BE CC C8 66      [17]  294         call z, sys_render_draw_stlvl7
   49C1 3A 6B 47      [13]  295     ld a, (level)
   49C4 FE 08         [ 7]  296     cp #8
   49C6 CC E0 66      [17]  297         call z, sys_render_draw_stlvl8
   49C9 3A 6B 47      [13]  298     ld a, (level)
   49CC FE 09         [ 7]  299     cp #9
   49CE CC F8 66      [17]  300         call z, sys_render_draw_stlvl9
   49D1 3A 6B 47      [13]  301     ld a, (level)
   49D4 FE 0A         [ 7]  302     cp #10
   49D6 CC 10 67      [17]  303         call z, sys_render_draw_stlvl10
...
Hexadecimal [16-Bits]
   ...
   49D9 C9            [10]  304 ret
                            305 
   49DA                     306 man_game_init_lvl_456::
   49DA CD 0F 66      [17]  307     call sys_render_update_bginit456
   49DD 3A 6B 47      [13]  308     ld a, (level)
   49E0 FE 0B         [ 7]  309     cp #11
   49E2 CC 28 67      [17]  310         call z, sys_render_draw_stlvl11
   49E5 3A 6B 47      [13]  311     ld a, (level)
   49E8 FE 0C         [ 7]  312     cp #12
   49EA CC 40 67      [17]  313         call z, sys_render_draw_stlvl12
   49ED 3A 6B 47      [13]  314     ld a, (level)
   49F0 FE 0D         [ 7]  315     cp #13
   49F2 CC 58 67      [17]  316         call z, sys_render_draw_stlvl13
   49F5 3A 6B 47      [13]  317     ld a, (level)
   49F8 FE 0E         [ 7]  318     cp #14
   49FA CC 70 67      [17]  319         call z, sys_render_draw_stlvl14
   49FD 3A 6B 47      [13]  320     ld a, (level)
   4A00 FE 0F         [ 7]  321     cp #15
   4A02 CC 88 67      [17]  322         call z, sys_render_draw_stlvl15
   4A05 3A 6B 47      [13]  323     ld a, (level)
   4A08 FE 10         [ 7]  324     cp #16
   4A0A CC A0 67      [17]  325         call z, sys_render_draw_stlvl16
   4A0D 3A 6B 47      [13]  326     ld a, (level)
   4A10 FE 11         [ 7]  327     cp #17
   4A12 CC B8 67      [17]  328         call z, sys_render_draw_stlvl17
   4A15 3A 6B 47      [13]  329     ld a, (level)
   4A18 FE 12         [ 7]  330     cp #18
   4A1A CC D0 67      [17]  331         call z, sys_render_draw_stlvl18
   4A1D 3A 6B 47      [13]  332     ld a, (level)
   4A20 FE 13         [ 7]  333     cp #19
   4A22 CC E8 67      [17]  334         call z, sys_render_draw_stlvl19
   4A25 3A 6B 47      [13]  335     ld a, (level)
   4A28 FE 14         [ 7]  336     cp #20
   4A2A CC 00 68      [17]  337         call z, sys_render_draw_stlvl20
   4A2D C9            [10]  338 ret
                            339 
   4A2E                     340 man_game_init_lvl_789::
   4A2E CD 19 66      [17]  341     call sys_render_update_bginit789
   4A31 3A 6B 47      [13]  342     ld a, (level)
   4A34 FE 15         [ 7]  343     cp #21
   4A36 CC 18 68      [17]  344         call z, sys_render_draw_stlvl21
   4A39 3A 6B 47      [13]  345     ld a, (level)
   4A3C FE 16         [ 7]  346     cp #22
   4A3E CC 30 68      [17]  347         call z, sys_render_draw_stlvl22
   4A41 3A 6B 47      [13]  348     ld a, (level)
   4A44 FE 17         [ 7]  349     cp #23
   4A46 CC 48 68      [17]  350         call z, sys_render_draw_stlvl23
   4A49 3A 6B 47      [13]  351     ld a, (level)
   4A4C FE 18         [ 7]  352     cp #24
   4A4E CC 60 68      [17]  353         call z, sys_render_draw_stlvl24
   4A51 3A 6B 47      [13]  354     ld a, (level)
   4A54 FE 19         [ 7]  355     cp #25
   4A56 CC 78 68      [17]  356         call z, sys_render_draw_stlvl25
   4A59 3A 6B 47      [13]  357     ld a, (level)
   4A5C FE 1A         [ 7]  358     cp #26
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 73.
Hexadecimal [16-Bits]



   4A5E CC 90 68      [17]  359         call z, sys_render_draw_stlvl26
   4A61 3A 6B 47      [13]  360     ld a, (level)
   4A64 FE 1B         [ 7]  361     cp #27
   4A66 CC A8 68      [17]  362         call z, sys_render_draw_stlvl27
   4A69 3A 6B 47      [13]  363     ld a, (level)
   4A6C FE 1C         [ 7]  364     cp #28
   4A6E CC C0 68      [17]  365         call z, sys_render_draw_stlvl28
   4A71 3A 6B 47      [13]  366     ld a, (level)
   4A74 FE 1D         [ 7]  367     cp #29
   4A76 CC D8 68      [17]  368         call z, sys_render_draw_stlvl29
   4A79 3A 6B 47      [13]  369     ld a, (level)
   4A7C FE 1E         [ 7]  370     cp #30
   4A7E CC F0 68      [17]  371         call z, sys_render_draw_stlvl30
   4A81 C9            [10]  372 ret
