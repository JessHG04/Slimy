...
Hexadecimal [16-Bits]
                             ...
                             25 
                             26 
   606A 00                   27 _tiempo_de_control:: .db 0
   606B 00                   28 _unidad_segundos:: .db 0
   606C 00                   29 _decena_segundos:: .db 0
   606D 00                   30 _juego_pausado:: .db 0          ;; 1 no pausado // 0 pausado
   606E 00                   31 _level_seconds:: .db 0
   606F 00                   32 animation_seconds:: .db 0
                             33 
   6070 35 00                34 _str_timers:   .asciz  "5"
   6072 31 00                35 _str_timerd:   .asciz  "1"
                             36 
                             37 ;;CONTROLA LAS INTERRUPCIONES DURANTE 1 SEGUNDO
   6074                      38 timer_control::
   6074 3A 6D 60      [13]   39     ld a, (_juego_pausado)
   6077 C8            [11]   40     ret z
   6078 3A 6A 60      [13]   41     ld      a, (_tiempo_de_control)
   607B FE 96         [ 7]   42     cp      #150                      ;; cada 300 interrupciones pasa 1 sec
   607D CC 85 60      [17]   43     call      z, timer_menos1s
   6080 3C            [ 4]   44     inc     a                       ;; si no, incrementamos y volvemos
   6081 32 6A 60      [13]   45     ld      (_tiempo_de_control), a
   6084 C9            [10]   46     ret
                             47 
                             48 ;;RESTA UN SEGUNDO AL CONTADOR
   6085                      49 timer_menos1s::
                             50     ;;Ha pasado un segundo del nivel
   6085 3A 6E 60      [13]   51     ld a, (_level_seconds)
   6088 3C            [ 4]   52     inc a
   6089 32 6E 60      [13]   53     ld (_level_seconds), a
                             54     ;; reseteamos el contador
   608C 3E 00         [ 7]   55     ld      a, #0
   608E 32 6A 60      [13]   56     ld      (_tiempo_de_control), a
                             57     ;; incrementamos los segundos
   6091 3A 6B 60      [13]   58     ld      a, (_unidad_segundos)
   6094 FE 00         [ 7]   59     cp #0
   6096 CC A6 60      [17]   60     call z, timer_menos1d ;;LLEGAN A 0 LOS SEGUNDOS 
   6099 3D            [ 4]   61     dec     a
                             62 
   609A 32 6B 60      [13]   63     ld      (_unidad_segundos), a  ;; lo, guardamos y volvemos
   609D 32 6F 60      [13]   64     ld      (animation_seconds), a
   60A0 C6 30         [ 7]   65     add #48 ;; PARA EL ASCI 
   60A2 32 70 60      [13]   66     ld (_str_timers), a
                             67 
   60A5 C9            [10]   68     ret
   60A6                      69 timer_menos1d::
                             70 
   60A6 3A 6C 60      [13]   71 ld a, (_decena_segundos)
   60A9 3D            [ 4]   72 dec a
   60AA FE FF         [ 7]   73 cp #-1
   60AC CC BA 60      [17]   74 call z,timer_clear ;;AL TERMINAR EL CONTADOR HACE ESTO
                             75 
   60AF 32 6C 60      [13]   76 ld (_decena_segundos), a
   60B2 C6 30         [ 7]   77 add #48 ;; PARA EL ASCI 
   60B4 32 72 60      [13]   78 ld (_str_timerd), a
...
Hexadecimal [16-Bits]
                             ...
                             79 
   60B7 3E 0A         [ 7]   80 ld a,  #10
   60B9 C9            [10]   81 ret
                             82 
   60BA                      83 timer_clear::;;BORRA TIMER E INVOCA PANTALLA NEXT LEVEL
                             84 
                             85     ;;Pauso el contador
   60BA 3E 00         [ 7]   86     ld a, #0
   60BC 32 6D 60      [13]   87     ld (_juego_pausado), a
                             88     ;;Incremento el nivel
   60BF 3A 6B 47      [13]   89     ld a, (level)
   60C2 3C            [ 4]   90     inc a
   60C3 32 6B 47      [13]   91     ld (level), a
                             92     ;;Invoco pantalla siguiente nivel
   60C6 CD 4C 60      [17]   93     call man_nextlevel_run
                             94 
   60C9 C9            [10]   95 ret
                             96 
   ...
   60CA 3E 00         [ 7]  100     ld a, #0 
   60CC 32 6E 60      [13]  101     ld (_level_seconds), a
                            102     ;;Reseteo el contador
   60CF 3E 00         [ 7]  103     ld a, #0  
   60D1 32 6B 60      [13]  104     ld (_unidad_segundos), a
   60D4 32 6F 60      [13]  105     ld (animation_seconds), a
   60D7 C6 30         [ 7]  106     add #48 ;; PARA EL ASCI 
   60D9 32 70 60      [13]  107     ld (_str_timers), a
   60DC 3E 03         [ 7]  108     ld a, #3
   60DE 32 6C 60      [13]  109     ld (_decena_segundos), a
   60E1 C6 30         [ 7]  110     add #48 ;; PARA EL ASCI 
   60E3 32 72 60      [13]  111     ld (_str_timerd), a
   60E6 C9            [10]  112     ret
                            113 ;;DIBUJA EL CRONOMETRO
   60E7                     114 timer_render::
                            115 
   60E7 C9            [10]  116 ret
