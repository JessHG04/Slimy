...
Hexadecimal [16-Bits]
                             ...
                             22 
   4A82 06                   23 uncontador: .db 06
                             24 
                             25 ;;Controla interrupciones
   4A83                      26 int_handler::
   4A83 F5            [11]   27 push af
   4A84 C5            [11]   28 push bc
   4A85 D5            [11]   29 push de
   4A86 E5            [11]   30 push hl
                             31 
   4A87 CD 74 60      [17]   32 call timer_control
   4A8A 3A 82 4A      [13]   33 ld a, (uncontador)
   4A8D 3D            [ 4]   34 dec a
   4A8E 20 05         [12]   35 jr nz, _cont
   4A90                      36 _zero:
   4A90 CD BC 6A      [17]   37 call cpct_akp_musicPlay_asm
   4A93 3E 06         [ 7]   38 ld a, #6 
   4A95                      39 _cont:
   4A95 32 82 4A      [13]   40 ld (uncontador), a
   4A98 E1            [10]   41 pop hl
   4A99 D1            [10]   42 pop de
   4A9A C1            [10]   43 pop bc
   4A9B F1            [10]   44 pop af
                             45 
   4A9C FB            [ 4]   46 ei
   4A9D ED 4D         [14]   47 reti
                             48 ;;INICIA INTERRUPCIONES
   4A9F                      49 set_int_handler:
   4A9F 21 38 00      [10]   50 ld hl, #0x38
   4AA2 36 C3         [10]   51 ld (hl), #0xC3
   4AA4 23            [ 6]   52 inc hl
   4AA5 36 83         [10]   53 ld (hl), #<int_handler
   4AA7 23            [ 6]   54 inc hl
   4AA8 36 4A         [10]   55 ld (hl), #>int_handler
   4AAA 23            [ 6]   56 inc hl
   4AAB 36 C9         [10]   57 ld (hl), #0xC9
   4AAD C9            [10]   58 ret
                             59 
