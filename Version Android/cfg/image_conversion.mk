...
$(eval $(call IMG2SP, SET_PALETTE_FW  , $(PALETTE)))
$(eval $(call IMG2SP, CONVERT, assets/Hero.png, 16, 16, hero_sp, hero_pal))
$(eval $(call IMG2SP, CONVERT, assets/Obstacle.png, 16, 12, obstacle_sp))
$(eval $(call IMG2SP, CONVERT, assets/FireBall.png, 16, 12, fireball_sp))
$(eval $(call IMG2SP, CONVERT, assets/Wave.png, 32, 24, wave_sp))
$(eval $(call IMG2SP, CONVERT, assets/Ghost.png, 16, 16, ghost_sp))
$(eval $(call IMG2SP, CONVERT, assets/BigFire.png, 16, 44, bigfire_sp))
$(eval $(call IMG2SP, CONVERT, assets/Salicornio.png, 16, 16, salicornio_sp))
$(eval $(call IMG2SP, SET_IMG_FORMAT  , screen))
$(eval $(call IMG2SP, SET_OUTPUT, bin))
$(eval $(call IMG2SP, CONVERT, assets/BgInit.png, 160, 200, bginit_sp))
$(eval $(call IMG2SP, CONVERT, assets/BgHallow.png, 160, 200, bghallow_sp))
$(eval $(call IMG2SP, CONVERT, assets/BgPrince.png, 160, 200, bgprince_sp))
$(eval $(call IMG2SP, CONVERT, assets/MenuInit.png, 160, 200, menuinit_sp))
$(eval $(call IMG2SP, CONVERT, assets/Win.png, 160, 200, win_sp))
#$(eval $(call IMG2SP, CONVERT, assets/Win.png, 160, 200, win_sp))
